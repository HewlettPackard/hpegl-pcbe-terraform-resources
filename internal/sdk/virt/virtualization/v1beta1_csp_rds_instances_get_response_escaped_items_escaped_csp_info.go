...
// V1beta1CspRdsInstancesGetResponse_items_cspInfo rDS machine instance properties whose values are defined by, and synchronized with, a cloud service provider.
type V1beta1CspRdsInstancesGetResponse_items_cspInfo struct {
    ...
    cspTags []V1beta1CspRdsInstancesGetResponse_items_cspInfo_cspTagsable
    // RDS Engine name
    engine *string
    ...
    networkInfo V1beta1CspRdsInstancesGetResponse_items_cspInfo_networkInfoable
    ...
    storageInfo V1beta1CspRdsInstancesGetResponse_items_cspInfo_storageInfoable
}
// NewV1beta1CspRdsInstancesGetResponse_items_cspInfo instantiates a new V1beta1CspRdsInstancesGetResponse_items_cspInfo and sets the default values.
func NewV1beta1CspRdsInstancesGetResponse_items_cspInfo()(*V1beta1CspRdsInstancesGetResponse_items_cspInfo) {
    m := &V1beta1CspRdsInstancesGetResponse_items_cspInfo{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1CspRdsInstancesGetResponse_items_cspInfoFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1CspRdsInstancesGetResponse_items_cspInfoFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1CspRdsInstancesGetResponse_items_cspInfo(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetAvailabilityZone gets the availabilityZone property value. Cloud provider availability zone
// returns a *string when successful
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetAvailabilityZone()(*string) {
    return m.availabilityZone
}
// GetClass gets the class property value. RDS Database instance Class
// returns a *string when successful
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetClass()(*string) {
    return m.class
}
// GetCspReference gets the cspReference property value. The reference Id for the asset with cloud service provider
// returns a *string when successful
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetCspReference()(*string) {
    return m.cspReference
}
// GetCspRegion gets the cspRegion property value. Cloud provider region
// returns a *string when successful
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetCspRegion()(*string) {
    return m.cspRegion
}
// GetCspTags gets the cspTags property value. The cspTags property
// returns a []V1beta1CspRdsInstancesGetResponse_items_cspInfo_cspTagsable when successful
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetCspTags()([]V1beta1CspRdsInstancesGetResponse_items_cspInfo_cspTagsable) {
    return m.cspTags
}
// GetEngine gets the engine property value. RDS Engine name
// returns a *string when successful
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetEngine()(*string) {
    return m.engine
}
// GetEngineVersion gets the engineVersion property value. RDS Database engine version
// returns a *string when successful
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetEngineVersion()(*string) {
    return m.engineVersion
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["cspTags"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1CspRdsInstancesGetResponse_items_cspInfo_cspTagsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1CspRdsInstancesGetResponse_items_cspInfo_cspTagsable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(V1beta1CspRdsInstancesGetResponse_items_cspInfo_cspTagsable)
                }
            }
            m.SetCspTags(res)
        }
    ...
    res["networkInfo"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1CspRdsInstancesGetResponse_items_cspInfo_networkInfoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetNetworkInfo(val.(V1beta1CspRdsInstancesGetResponse_items_cspInfo_networkInfoable))
        }
        return nil
    }
    ...
    res["storageInfo"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1CspRdsInstancesGetResponse_items_cspInfo_storageInfoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetStorageInfo(val.(V1beta1CspRdsInstancesGetResponse_items_cspInfo_storageInfoable))
        }
        return nil
    }
    return res
...
// returns a *string when successful
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetIdentifier()(*string) {
    return m.identifier
}
// GetKmsKeyId gets the kmsKeyId property value. Optional keyId if the machine instance is encrypted
// returns a *string when successful
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetKmsKeyId()(*string) {
    return m.kmsKeyId
}
...
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetMultiAz()(*bool) {
    return m.multiAz
}
// GetNetworkInfo gets the networkInfo property value. Network properties for the machine instance
// returns a V1beta1CspRdsInstancesGetResponse_items_cspInfo_networkInfoable when successful
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetNetworkInfo()(V1beta1CspRdsInstancesGetResponse_items_cspInfo_networkInfoable) {
    return m.networkInfo
}
// GetOptionGroupNames gets the optionGroupNames property value. The optionGroupNames property
// returns a []string when successful
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetOptionGroupNames()([]string) {
...
// returns a []string when successful
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetParameterGroupNames()([]string) {
...
// returns a *string when successful
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetSecondaryAvailabilityZone()(*string) {
...
// returns a *string when successful
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetStatus()(*string) {
    return m.status
}
// GetStorageInfo gets the storageInfo property value. Storage information of the RDS Database instance
// returns a V1beta1CspRdsInstancesGetResponse_items_cspInfo_storageInfoable when successful
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) GetStorageInfo()(V1beta1CspRdsInstancesGetResponse_items_cspInfo_storageInfoable) {
    return m.storageInfo
}
// Serialize serializes information the current object
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetAvailabilityZone sets the availabilityZone property value. Cloud provider availability zone
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) SetAvailabilityZone(value *string)() {
    m.availabilityZone = value
}
// SetClass sets the class property value. RDS Database instance Class
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) SetClass(value *string)() {
    m.class = value
}
// SetCspReference sets the cspReference property value. The reference Id for the asset with cloud service provider
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) SetCspReference(value *string)() {
    m.cspReference = value
}
// SetCspRegion sets the cspRegion property value. Cloud provider region
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) SetCspRegion(value *string)() {
    m.cspRegion = value
}
// SetCspTags sets the cspTags property value. The cspTags property
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) SetCspTags(value []V1beta1CspRdsInstancesGetResponse_items_cspInfo_cspTagsable)() {
    m.cspTags = value
}
// SetEngine sets the engine property value. RDS Engine name
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) SetEngine(value *string)() {
    m.engine = value
}
// SetEngineVersion sets the engineVersion property value. RDS Database engine version
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) SetEngineVersion(value *string)() {
    m.engineVersion = value
}
// SetIdentifier sets the identifier property value. RDS database instance identifier
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) SetIdentifier(value *string)() {
    m.identifier = value
}
// SetKmsKeyId sets the kmsKeyId property value. Optional keyId if the machine instance is encrypted
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) SetKmsKeyId(value *string)() {
    m.kmsKeyId = value
}
// SetMultiAz sets the multiAz property value. Indicated if the RDS database instance is deployed in Multi-AZ deployment
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) SetMultiAz(value *bool)() {
    m.multiAz = value
}
// SetNetworkInfo sets the networkInfo property value. Network properties for the machine instance
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) SetNetworkInfo(value V1beta1CspRdsInstancesGetResponse_items_cspInfo_networkInfoable)() {
    m.networkInfo = value
}
// SetOptionGroupNames sets the optionGroupNames property value. The optionGroupNames property
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) SetOptionGroupNames(value []string)() {
...
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) SetParameterGroupNames(value []string)() {
...
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) SetSecondaryAvailabilityZone(value *string)() {
...
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) SetStatus(value *string)() {
    m.status = value
}
// SetStorageInfo sets the storageInfo property value. Storage information of the RDS Database instance
func (m *V1beta1CspRdsInstancesGetResponse_items_cspInfo) SetStorageInfo(value V1beta1CspRdsInstancesGetResponse_items_cspInfo_storageInfoable)() {
    m.storageInfo = value
}
type V1beta1CspRdsInstancesGetResponse_items_cspInfoable interface {
    ...
    GetCspRegion()(*string)
    GetCspTags()([]V1beta1CspRdsInstancesGetResponse_items_cspInfo_cspTagsable)
    GetEngine()(*string)
    GetEngineVersion()(*string)
    GetIdentifier()(*string)
    GetKmsKeyId()(*string)
    GetMultiAz()(*bool)
    GetNetworkInfo()(V1beta1CspRdsInstancesGetResponse_items_cspInfo_networkInfoable)
    GetOptionGroupNames()([]string)
    GetParameterGroupNames()([]string)
    GetSecondaryAvailabilityZone()(*string)
    GetStatus()(*string)
    GetStorageInfo()(V1beta1CspRdsInstancesGetResponse_items_cspInfo_storageInfoable)
    SetAvailabilityZone(value *string)()
    SetClass(value *string)()
    SetCspReference(value *string)()
    SetCspRegion(value *string)()
    SetCspTags(value []V1beta1CspRdsInstancesGetResponse_items_cspInfo_cspTagsable)()
    SetEngine(value *string)()
    SetEngineVersion(value *string)()
    SetIdentifier(value *string)()
    SetKmsKeyId(value *string)()
    SetMultiAz(value *bool)()
    SetNetworkInfo(value V1beta1CspRdsInstancesGetResponse_items_cspInfo_networkInfoable)()
    SetOptionGroupNames(value []string)()
    SetParameterGroupNames(value []string)()
    SetSecondaryAvailabilityZone(value *string)()
    SetStatus(value *string)()
    SetStorageInfo(value V1beta1CspRdsInstancesGetResponse_items_cspInfo_storageInfoable)()
}
