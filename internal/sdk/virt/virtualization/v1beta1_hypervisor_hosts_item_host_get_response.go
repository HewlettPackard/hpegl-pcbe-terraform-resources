...
// V1beta1HypervisorHostsItemHostGetResponse represents a single instance of a hypervisor host (Vmware ESXi)
type V1beta1HypervisorHostsItemHostGetResponse struct {
    // Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additionalData map[string]any
    // Application specific information for this host.
    appInfo V1beta1HypervisorHostsItemHostGetResponse_appInfoable
    // CPU information.
    cpuInfo V1beta1HypervisorHostsItemHostGetResponse_cpuInfoable
    // CPU sockets information.
    cpuSockets []V1beta1HypervisorHostsItemHostGetResponse_cpuSocketsable
    ...
    hostNetworkSystem V1beta1HypervisorHostsItemHostGetResponse_hostNetworkSystemable
    // Hypervisor host performance metrics.
    hostPerfMetricInfo V1beta1HypervisorHostsItemHostGetResponse_hostPerfMetricInfoable
    // The hypervisorManagerInfo property
    hypervisorManagerInfo V1beta1HypervisorHostsItemHostGetResponse_hypervisorManagerInfoable
    ...
    parentInfo V1beta1HypervisorHostsItemHostGetResponse_parentInfoable
    ...
    storageAdaptersInfo []V1beta1HypervisorHostsItemHostGetResponse_storageAdaptersInfoable
...
// NewV1beta1HypervisorHostsItemHostGetResponse instantiates a new V1beta1HypervisorHostsItemHostGetResponse and sets the default values.
func NewV1beta1HypervisorHostsItemHostGetResponse()(*V1beta1HypervisorHostsItemHostGetResponse) {
    m := &V1beta1HypervisorHostsItemHostGetResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1HypervisorHostsItemHostGetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1HypervisorHostsItemHostGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1HypervisorHostsItemHostGetResponse(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetAppInfo gets the appInfo property value. Application specific information for this host.
// returns a V1beta1HypervisorHostsItemHostGetResponse_appInfoable when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetAppInfo()(V1beta1HypervisorHostsItemHostGetResponse_appInfoable) {
    return m.appInfo
}
// GetCpuInfo gets the cpuInfo property value. CPU information.
// returns a V1beta1HypervisorHostsItemHostGetResponse_cpuInfoable when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetCpuInfo()(V1beta1HypervisorHostsItemHostGetResponse_cpuInfoable) {
    return m.cpuInfo
}
// GetCpuSockets gets the cpuSockets property value. CPU sockets information.
// returns a []V1beta1HypervisorHostsItemHostGetResponse_cpuSocketsable when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetCpuSockets()([]V1beta1HypervisorHostsItemHostGetResponse_cpuSocketsable) {
    return m.cpuSockets
}
// GetCreatedAt gets the createdAt property value. Time in UTC at which the object was created
// returns a *Time when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetCreatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.createdAt
}
// GetCustomerId gets the customerId property value. The customer application identifier.
// returns a *string when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetCustomerId()(*string) {
    return m.customerId
}
...
// returns a *string when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetDisplayName()(*string) {
    return m.displayName
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["appInfo"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1HypervisorHostsItemHostGetResponse_appInfoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetAppInfo(val.(V1beta1HypervisorHostsItemHostGetResponse_appInfoable))
        }
        return nil
    }
    res["cpuInfo"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1HypervisorHostsItemHostGetResponse_cpuInfoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetCpuInfo(val.(V1beta1HypervisorHostsItemHostGetResponse_cpuInfoable))
        }
        return nil
    }
    res["cpuSockets"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1HypervisorHostsItemHostGetResponse_cpuSocketsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1HypervisorHostsItemHostGetResponse_cpuSocketsable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(V1beta1HypervisorHostsItemHostGetResponse_cpuSocketsable)
                }
            }
            m.SetCpuSockets(res)
        }
    ...
    res["hostNetworkSystem"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1HypervisorHostsItemHostGetResponse_hostNetworkSystemFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetHostNetworkSystem(val.(V1beta1HypervisorHostsItemHostGetResponse_hostNetworkSystemable))
        }
        return nil
    }
    res["hostPerfMetricInfo"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1HypervisorHostsItemHostGetResponse_hostPerfMetricInfoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetHostPerfMetricInfo(val.(V1beta1HypervisorHostsItemHostGetResponse_hostPerfMetricInfoable))
        }
        return nil
    }
    res["hypervisorManagerInfo"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1HypervisorHostsItemHostGetResponse_hypervisorManagerInfoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetHypervisorManagerInfo(val.(V1beta1HypervisorHostsItemHostGetResponse_hypervisorManagerInfoable))
        }
        return nil
    }
    ...
    res["parentInfo"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1HypervisorHostsItemHostGetResponse_parentInfoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetParentInfo(val.(V1beta1HypervisorHostsItemHostGetResponse_parentInfoable))
        }
        return nil
    }
    ...
    res["storageAdaptersInfo"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1HypervisorHostsItemHostGetResponse_storageAdaptersInfoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1HypervisorHostsItemHostGetResponse_storageAdaptersInfoable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(V1beta1HypervisorHostsItemHostGetResponse_storageAdaptersInfoable)
                }
            }
...
// returns a *string when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetFqdn()(*string) {
    return m.fqdn
}
...
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetGeneration()(*int64) {
    return m.generation
}
// GetHciClusterUuid gets the hciClusterUuid property value. UUID string uniquely identifying the HCI cluster.
// returns a *string when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetHciClusterUuid()(*string) {
...
// returns a *string when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetHciServerUuid()(*string) {
    return m.hciServerUuid
}
// GetHostNetworkSystem gets the hostNetworkSystem property value. Host network system information.
// returns a V1beta1HypervisorHostsItemHostGetResponse_hostNetworkSystemable when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetHostNetworkSystem()(V1beta1HypervisorHostsItemHostGetResponse_hostNetworkSystemable) {
...
// returns a V1beta1HypervisorHostsItemHostGetResponse_hostPerfMetricInfoable when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetHostPerfMetricInfo()(V1beta1HypervisorHostsItemHostGetResponse_hostPerfMetricInfoable) {
...
// returns a V1beta1HypervisorHostsItemHostGetResponse_hypervisorManagerInfoable when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetHypervisorManagerInfo()(V1beta1HypervisorHostsItemHostGetResponse_hypervisorManagerInfoable) {
    return m.hypervisorManagerInfo
}
// GetId gets the id property value. UUID string uniquely identifying the hypervisor host.
// returns a *string when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetId()(*string) {
    return m.id
}
// GetInMaintenanceMode gets the inMaintenanceMode property value. maintenance mode status of hypervisor host.
// returns a *bool when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetInMaintenanceMode()(*bool) {
    return m.inMaintenanceMode
}
// GetName gets the name property value. Name of the host as reported by the hypervisor manager.
// returns a *string when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetName()(*string) {
    return m.name
}
...
// returns a *string when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetNetworkAddress()(*string) {
...
// returns a []string when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetNetworksInfo()([]string) {
...
// returns a V1beta1HypervisorHostsItemHostGetResponse_parentInfoable when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetParentInfo()(V1beta1HypervisorHostsItemHostGetResponse_parentInfoable) {
    return m.parentInfo
}
// GetResourceUri gets the resourceUri property value. The 'self' reference for this resource.
// returns a *string when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetResourceUri()(*string) {
...
// returns a []string when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetServices()([]string) {
    return m.services
}
// GetStateReason gets the stateReason property value. Brief reason for the current state of the hypervisor host
// returns a *string when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetStateReason()(*string) {
...
// returns a []V1beta1HypervisorHostsItemHostGetResponse_storageAdaptersInfoable when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetStorageAdaptersInfo()([]V1beta1HypervisorHostsItemHostGetResponse_storageAdaptersInfoable) {
    return m.storageAdaptersInfo
}
// GetTypeEscaped gets the type property value. The type of resource.
// returns a *string when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetTypeEscaped()(*string) {
    return m.typeEscaped
}
// GetUid gets the uid property value. A hypervisor host provided durable UID.
// returns a *string when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetUid()(*string) {
    return m.uid
}
// GetUpdatedAt gets the updatedAt property value. Time in UTC at which the object was last updated
// returns a *Time when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetUpdatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.updatedAt
}
// GetVersion gets the version property value. The hypervisor host version.
// returns a *string when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse) GetVersion()(*string) {
    return m.version
}
// Serialize serializes information the current object
func (m *V1beta1HypervisorHostsItemHostGetResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetAppInfo sets the appInfo property value. Application specific information for this host.
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetAppInfo(value V1beta1HypervisorHostsItemHostGetResponse_appInfoable)() {
    m.appInfo = value
}
// SetCpuInfo sets the cpuInfo property value. CPU information.
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetCpuInfo(value V1beta1HypervisorHostsItemHostGetResponse_cpuInfoable)() {
    m.cpuInfo = value
}
// SetCpuSockets sets the cpuSockets property value. CPU sockets information.
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetCpuSockets(value []V1beta1HypervisorHostsItemHostGetResponse_cpuSocketsable)() {
    m.cpuSockets = value
}
// SetCreatedAt sets the createdAt property value. Time in UTC at which the object was created
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetCreatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.createdAt = value
}
// SetCustomerId sets the customerId property value. The customer application identifier.
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetCustomerId(value *string)() {
    m.customerId = value
}
...
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetDisplayName(value *string)() {
    m.displayName = value
}
// SetFqdn sets the fqdn property value. fqdn value of hypervisor host.
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetFqdn(value *string)() {
    m.fqdn = value
}
...
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetGeneration(value *int64)() {
    m.generation = value
}
// SetHciClusterUuid sets the hciClusterUuid property value. UUID string uniquely identifying the HCI cluster.
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetHciClusterUuid(value *string)() {
...
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetHciServerUuid(value *string)() {
    m.hciServerUuid = value
}
// SetHostNetworkSystem sets the hostNetworkSystem property value. Host network system information.
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetHostNetworkSystem(value V1beta1HypervisorHostsItemHostGetResponse_hostNetworkSystemable)() {
...
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetHostPerfMetricInfo(value V1beta1HypervisorHostsItemHostGetResponse_hostPerfMetricInfoable)() {
...
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetHypervisorManagerInfo(value V1beta1HypervisorHostsItemHostGetResponse_hypervisorManagerInfoable)() {
    m.hypervisorManagerInfo = value
}
// SetId sets the id property value. UUID string uniquely identifying the hypervisor host.
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetId(value *string)() {
    m.id = value
}
// SetInMaintenanceMode sets the inMaintenanceMode property value. maintenance mode status of hypervisor host.
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetInMaintenanceMode(value *bool)() {
    m.inMaintenanceMode = value
}
// SetName sets the name property value. Name of the host as reported by the hypervisor manager.
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetName(value *string)() {
    m.name = value
}
...
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetNetworkAddress(value *string)() {
...
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetNetworksInfo(value []string)() {
...
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetParentInfo(value V1beta1HypervisorHostsItemHostGetResponse_parentInfoable)() {
    m.parentInfo = value
}
// SetResourceUri sets the resourceUri property value. The 'self' reference for this resource.
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetResourceUri(value *string)() {
    m.resourceUri = value
}
...
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetServices(value []string)() {
    m.services = value
}
// SetStateReason sets the stateReason property value. Brief reason for the current state of the hypervisor host
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetStateReason(value *string)() {
    m.stateReason = value
}
// SetStorageAdaptersInfo sets the storageAdaptersInfo property value. List of storage adapters associated with this host.
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetStorageAdaptersInfo(value []V1beta1HypervisorHostsItemHostGetResponse_storageAdaptersInfoable)() {
    m.storageAdaptersInfo = value
}
// SetTypeEscaped sets the type property value. The type of resource.
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetTypeEscaped(value *string)() {
    m.typeEscaped = value
}
// SetUid sets the uid property value. A hypervisor host provided durable UID.
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetUid(value *string)() {
    m.uid = value
}
// SetUpdatedAt sets the updatedAt property value. Time in UTC at which the object was last updated
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetUpdatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.updatedAt = value
}
// SetVersion sets the version property value. The hypervisor host version.
func (m *V1beta1HypervisorHostsItemHostGetResponse) SetVersion(value *string)() {
    m.version = value
}
type V1beta1HypervisorHostsItemHostGetResponseable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetAppInfo()(V1beta1HypervisorHostsItemHostGetResponse_appInfoable)
    GetCpuInfo()(V1beta1HypervisorHostsItemHostGetResponse_cpuInfoable)
    GetCpuSockets()([]V1beta1HypervisorHostsItemHostGetResponse_cpuSocketsable)
    ...
    GetHostNetworkSystem()(V1beta1HypervisorHostsItemHostGetResponse_hostNetworkSystemable)
    GetHostPerfMetricInfo()(V1beta1HypervisorHostsItemHostGetResponse_hostPerfMetricInfoable)
    GetHypervisorManagerInfo()(V1beta1HypervisorHostsItemHostGetResponse_hypervisorManagerInfoable)
    GetId()(*string)
    GetInMaintenanceMode()(*bool)
    GetName()(*string)
    GetNetworkAddress()(*string)
    GetNetworksInfo()([]string)
    GetParentInfo()(V1beta1HypervisorHostsItemHostGetResponse_parentInfoable)
    GetResourceUri()(*string)
    GetServices()([]string)
    GetStateReason()(*string)
    GetStorageAdaptersInfo()([]V1beta1HypervisorHostsItemHostGetResponse_storageAdaptersInfoable)
    GetTypeEscaped()(*string)
    GetUid()(*string)
    GetUpdatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)
    GetVersion()(*string)
    SetAppInfo(value V1beta1HypervisorHostsItemHostGetResponse_appInfoable)()
    SetCpuInfo(value V1beta1HypervisorHostsItemHostGetResponse_cpuInfoable)()
    SetCpuSockets(value []V1beta1HypervisorHostsItemHostGetResponse_cpuSocketsable)()
    ...
    SetHostNetworkSystem(value V1beta1HypervisorHostsItemHostGetResponse_hostNetworkSystemable)()
    SetHostPerfMetricInfo(value V1beta1HypervisorHostsItemHostGetResponse_hostPerfMetricInfoable)()
    SetHypervisorManagerInfo(value V1beta1HypervisorHostsItemHostGetResponse_hypervisorManagerInfoable)()
    SetId(value *string)()
    SetInMaintenanceMode(value *bool)()
    SetName(value *string)()
    SetNetworkAddress(value *string)()
    SetNetworksInfo(value []string)()
    SetParentInfo(value V1beta1HypervisorHostsItemHostGetResponse_parentInfoable)()
    SetResourceUri(value *string)()
    SetServices(value []string)()
    SetStateReason(value *string)()
    SetStorageAdaptersInfo(value []V1beta1HypervisorHostsItemHostGetResponse_storageAdaptersInfoable)()
