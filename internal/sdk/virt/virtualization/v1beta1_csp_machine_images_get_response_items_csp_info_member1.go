...
type V1beta1CspMachineImagesGetResponse_items_cspInfoMember1 struct {
    ...
    blockDeviceMappings []V1beta1CspMachineImagesGetResponse_items_cspInfoMember1_blockDeviceMappingsable
...
// NewV1beta1CspMachineImagesGetResponse_items_cspInfoMember1 instantiates a new V1beta1CspMachineImagesGetResponse_items_cspInfoMember1 and sets the default values.
func NewV1beta1CspMachineImagesGetResponse_items_cspInfoMember1()(*V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) {
    m := &V1beta1CspMachineImagesGetResponse_items_cspInfoMember1{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1CspMachineImagesGetResponse_items_cspInfoMember1FromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1CspMachineImagesGetResponse_items_cspInfoMember1FromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1CspMachineImagesGetResponse_items_cspInfoMember1(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetArchitecture gets the architecture property value. The cloud machine image architecture (i386 | x86_64 | arm64 ).
// returns a *string when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetArchitecture()(*string) {
...
// returns a []V1beta1CspMachineImagesGetResponse_items_cspInfoMember1_blockDeviceMappingsable when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetBlockDeviceMappings()([]V1beta1CspMachineImagesGetResponse_items_cspInfoMember1_blockDeviceMappingsable) {
...
// returns a *string when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetDescription()(*string) {
    return m.description
}
// GetEnaSupport gets the enaSupport property value. Specifies whether enhanced networking with ENA is enabled.
// returns a *bool when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetEnaSupport()(*bool) {
    return m.enaSupport
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["blockDeviceMappings"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1CspMachineImagesGetResponse_items_cspInfoMember1_blockDeviceMappingsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1CspMachineImagesGetResponse_items_cspInfoMember1_blockDeviceMappingsable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(V1beta1CspMachineImagesGetResponse_items_cspInfoMember1_blockDeviceMappingsable)
                }
            }
...
// returns a *string when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetHypervisor()(*string) {
    return m.hypervisor
}
// GetId gets the id property value. Resource identifier assigned by the cloud provider
// returns a *string when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetId()(*string) {
    return m.id
}
// GetImageType gets the imageType property value. The type of image.
// returns a *string when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetImageType()(*string) {
    return m.imageType
}
// GetLocation gets the location property value. The location of the AMI.
// returns a *string when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetLocation()(*string) {
    return m.location
}
...
// returns a *string when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetOwnerAlias()(*string) {
    return m.ownerAlias
}
// GetOwnerId gets the ownerId property value. The ID of the Amazon Web Services account that owns the image.
// returns a *string when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetOwnerId()(*string) {
    return m.ownerId
}
...
// returns a *string when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetPlatformDetails()(*string) {
...
// returns a *bool when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetPublic()(*bool) {
    return m.public
}
// GetRegion gets the region property value. Cloud provider region.
// returns a *string when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetRegion()(*string) {
    return m.region
}
// GetRootDeviceName gets the rootDeviceName property value. The device name of the root device volume.
// returns a *string when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetRootDeviceName()(*string) {
...
// returns a *string when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetRootDeviceType()(*string) {
...
// returns a *string when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetSriovNetSupport()(*string) {
...
// returns a *string when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetState()(*string) {
    return m.state
}
...
// returns a *string when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetUsageOperation()(*string) {
...
// returns a *string when successful
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) GetVirtualizationType()(*string) {
    return m.virtualizationType
}
// Serialize serializes information the current object
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetArchitecture sets the architecture property value. The cloud machine image architecture (i386 | x86_64 | arm64 ).
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetArchitecture(value *string)() {
...
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetBlockDeviceMappings(value []V1beta1CspMachineImagesGetResponse_items_cspInfoMember1_blockDeviceMappingsable)() {
    m.blockDeviceMappings = value
}
// SetDescription sets the description property value. The description of the cloud machine image.
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetDescription(value *string)() {
    m.description = value
}
// SetEnaSupport sets the enaSupport property value. Specifies whether enhanced networking with ENA is enabled.
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetEnaSupport(value *bool)() {
    m.enaSupport = value
}
// SetHypervisor sets the hypervisor property value. The hypervisor type of the image.
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetHypervisor(value *string)() {
    m.hypervisor = value
}
// SetId sets the id property value. Resource identifier assigned by the cloud provider
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetId(value *string)() {
    m.id = value
}
// SetImageType sets the imageType property value. The type of image.
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetImageType(value *string)() {
    m.imageType = value
}
// SetLocation sets the location property value. The location of the AMI.
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetLocation(value *string)() {
    m.location = value
}
...
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetOwnerAlias(value *string)() {
    m.ownerAlias = value
}
// SetOwnerId sets the ownerId property value. The ID of the Amazon Web Services account that owns the image.
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetOwnerId(value *string)() {
    m.ownerId = value
}
...
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetPlatformDetails(value *string)() {
...
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetPublic(value *bool)() {
    m.public = value
}
// SetRegion sets the region property value. Cloud provider region.
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetRegion(value *string)() {
    m.region = value
}
// SetRootDeviceName sets the rootDeviceName property value. The device name of the root device volume.
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetRootDeviceName(value *string)() {
...
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetRootDeviceType(value *string)() {
...
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetSriovNetSupport(value *string)() {
...
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetState(value *string)() {
    m.state = value
}
...
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetUsageOperation(value *string)() {
...
func (m *V1beta1CspMachineImagesGetResponse_items_cspInfoMember1) SetVirtualizationType(value *string)() {
    m.virtualizationType = value
}
type V1beta1CspMachineImagesGetResponse_items_cspInfoMember1able interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetArchitecture()(*string)
    GetBlockDeviceMappings()([]V1beta1CspMachineImagesGetResponse_items_cspInfoMember1_blockDeviceMappingsable)
    ...
    SetBlockDeviceMappings(value []V1beta1CspMachineImagesGetResponse_items_cspInfoMember1_blockDeviceMappingsable)()
