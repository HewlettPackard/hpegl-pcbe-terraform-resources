...
// V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo the optimized EBS performance for the instance type.
type V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo struct {
...
// NewV1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo instantiates a new V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo and sets the default values.
func NewV1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo()(*V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo) {
    m := &V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfoFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfoFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo) GetAdditionalData()(map[string]any) {
...
func (m *V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo) GetBaselineBandwidthInMbps()(*int32) {
...
// returns a *int32 when successful
func (m *V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo) GetBaselineIops()(*int32) {
...
func (m *V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo) GetBaselineThroughputInMbps()(*float64) {
    return m.baselineThroughputInMbps
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *int32 when successful
func (m *V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo) GetMaximumBandwidthInMbps()(*int32) {
...
// returns a *int32 when successful
func (m *V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo) GetMaximumIops()(*int32) {
...
// returns a *float64 when successful
func (m *V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo) GetMaximumThroughputInMbps()(*float64) {
    return m.maximumThroughputInMbps
}
// Serialize serializes information the current object
func (m *V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo) SetAdditionalData(value map[string]any)() {
...
func (m *V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo) SetBaselineBandwidthInMbps(value *int32)() {
...
func (m *V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo) SetBaselineIops(value *int32)() {
...
func (m *V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo) SetBaselineThroughputInMbps(value *float64)() {
...
func (m *V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo) SetMaximumBandwidthInMbps(value *int32)() {
...
func (m *V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo) SetMaximumIops(value *int32)() {
    m.maximumIops = value
}
...
func (m *V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfo) SetMaximumThroughputInMbps(value *float64)() {
    m.maximumThroughputInMbps = value
}
type V1beta1CspMachineInstanceTypesGetResponse_items_cspInfoMember1_ebsInfo_ebsOptimizedInfoable interface {
