...
// V1beta1HypervisorManagersGetResponse_items represents a single instance of a hypervisor manager (Vmware vCenter)
type V1beta1HypervisorManagersGetResponse_items struct {
    // Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additionalData map[string]any
    // Hypervisor specific information.
    appInfo V1beta1HypervisorManagersGetResponse_items_appInfoable
    ...
    dataOrchestratorInfo V1beta1HypervisorManagersGetResponse_items_dataOrchestratorInfoable
    // Data Services Connectors specific information.
    dataServicesConnectorsInfo []V1beta1HypervisorManagersGetResponse_items_dataServicesConnectorsInfoable
...
// NewV1beta1HypervisorManagersGetResponse_items instantiates a new V1beta1HypervisorManagersGetResponse_items and sets the default values.
func NewV1beta1HypervisorManagersGetResponse_items()(*V1beta1HypervisorManagersGetResponse_items) {
    m := &V1beta1HypervisorManagersGetResponse_items{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1HypervisorManagersGetResponse_itemsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1HypervisorManagersGetResponse_itemsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1HypervisorManagersGetResponse_items(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetAppInfo gets the appInfo property value. Hypervisor specific information.
// returns a V1beta1HypervisorManagersGetResponse_items_appInfoable when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetAppInfo()(V1beta1HypervisorManagersGetResponse_items_appInfoable) {
    return m.appInfo
}
// GetBuildVersion gets the buildVersion property value. The hypervisor manager build details
// returns a *string when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetBuildVersion()(*string) {
    return m.buildVersion
}
// GetCreatedAt gets the createdAt property value. Time in UTC at which the object was created
// returns a *Time when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetCreatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.createdAt
}
// GetCustomerId gets the customerId property value. The customer application identifier.
// returns a *string when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetCustomerId()(*string) {
    return m.customerId
}
// GetDataOrchestratorInfo gets the dataOrchestratorInfo property value. Data Orchestrator specific information.
// returns a V1beta1HypervisorManagersGetResponse_items_dataOrchestratorInfoable when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetDataOrchestratorInfo()(V1beta1HypervisorManagersGetResponse_items_dataOrchestratorInfoable) {
...
// returns a []V1beta1HypervisorManagersGetResponse_items_dataServicesConnectorsInfoable when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetDataServicesConnectorsInfo()([]V1beta1HypervisorManagersGetResponse_items_dataServicesConnectorsInfoable) {
...
// returns a *string when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetDescription()(*string) {
    return m.description
}
// GetDisplayName gets the displayName property value. User defined name for the hypervisor manager.
// returns a *string when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetDisplayName()(*string) {
    return m.displayName
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["appInfo"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1HypervisorManagersGetResponse_items_appInfoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetAppInfo(val.(V1beta1HypervisorManagersGetResponse_items_appInfoable))
        }
        return nil
    }
    ...
    res["dataOrchestratorInfo"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1HypervisorManagersGetResponse_items_dataOrchestratorInfoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetDataOrchestratorInfo(val.(V1beta1HypervisorManagersGetResponse_items_dataOrchestratorInfoable))
        }
        return nil
    }
    res["dataServicesConnectorsInfo"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1HypervisorManagersGetResponse_items_dataServicesConnectorsInfoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1HypervisorManagersGetResponse_items_dataServicesConnectorsInfoable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(V1beta1HypervisorManagersGetResponse_items_dataServicesConnectorsInfoable)
                }
            }
...
func (m *V1beta1HypervisorManagersGetResponse_items) GetGeneration()(*int64) {
    return m.generation
}
// GetId gets the id property value. UUID string uniquely identifying the hypervisor manager.
// returns a *string when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetId()(*string) {
    return m.id
}
// GetLastRefreshed gets the lastRefreshed property value. Time in UTC at which the object was last refreshed.
// returns a *Time when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetLastRefreshed()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.lastRefreshed
}
// GetName gets the name property value. Name as reported by the hypervisor manager.
// returns a *string when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetName()(*string) {
    return m.name
}
...
// returns a []string when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetServices()([]string) {
    return m.services
}
// GetStateReason gets the stateReason property value. Brief reason for the current state of the hypervisor manager
// returns a *string when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetStateReason()(*string) {
    return m.stateReason
}
// GetTypeEscaped gets the type property value. The type of resource.
// returns a *string when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetTypeEscaped()(*string) {
...
// returns a *string when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetUid()(*string) {
    return m.uid
}
// GetUpdatedAt gets the updatedAt property value. Time in UTC at which the object was last updated
// returns a *Time when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetUpdatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.updatedAt
}
...
// returns a *string when successful
func (m *V1beta1HypervisorManagersGetResponse_items) GetUsername()(*string) {
    return m.username
}
// Serialize serializes information the current object
func (m *V1beta1HypervisorManagersGetResponse_items) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1HypervisorManagersGetResponse_items) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetAppInfo sets the appInfo property value. Hypervisor specific information.
func (m *V1beta1HypervisorManagersGetResponse_items) SetAppInfo(value V1beta1HypervisorManagersGetResponse_items_appInfoable)() {
    m.appInfo = value
}
// SetBuildVersion sets the buildVersion property value. The hypervisor manager build details
func (m *V1beta1HypervisorManagersGetResponse_items) SetBuildVersion(value *string)() {
    m.buildVersion = value
}
// SetCreatedAt sets the createdAt property value. Time in UTC at which the object was created
func (m *V1beta1HypervisorManagersGetResponse_items) SetCreatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.createdAt = value
}
// SetCustomerId sets the customerId property value. The customer application identifier.
func (m *V1beta1HypervisorManagersGetResponse_items) SetCustomerId(value *string)() {
    m.customerId = value
}
// SetDataOrchestratorInfo sets the dataOrchestratorInfo property value. Data Orchestrator specific information.
func (m *V1beta1HypervisorManagersGetResponse_items) SetDataOrchestratorInfo(value V1beta1HypervisorManagersGetResponse_items_dataOrchestratorInfoable)() {
...
func (m *V1beta1HypervisorManagersGetResponse_items) SetDataServicesConnectorsInfo(value []V1beta1HypervisorManagersGetResponse_items_dataServicesConnectorsInfoable)() {
...
func (m *V1beta1HypervisorManagersGetResponse_items) SetDescription(value *string)() {
    m.description = value
}
// SetDisplayName sets the displayName property value. User defined name for the hypervisor manager.
func (m *V1beta1HypervisorManagersGetResponse_items) SetDisplayName(value *string)() {
    m.displayName = value
}
...
func (m *V1beta1HypervisorManagersGetResponse_items) SetGeneration(value *int64)() {
    m.generation = value
}
// SetId sets the id property value. UUID string uniquely identifying the hypervisor manager.
func (m *V1beta1HypervisorManagersGetResponse_items) SetId(value *string)() {
    m.id = value
}
// SetLastRefreshed sets the lastRefreshed property value. Time in UTC at which the object was last refreshed.
func (m *V1beta1HypervisorManagersGetResponse_items) SetLastRefreshed(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.lastRefreshed = value
}
// SetName sets the name property value. Name as reported by the hypervisor manager.
func (m *V1beta1HypervisorManagersGetResponse_items) SetName(value *string)() {
    m.name = value
}
...
func (m *V1beta1HypervisorManagersGetResponse_items) SetNetworkAddress(value *string)() {
    m.networkAddress = value
}
// SetReleaseVersion sets the releaseVersion property value. The hypervisor manager release version.
func (m *V1beta1HypervisorManagersGetResponse_items) SetReleaseVersion(value *string)() {
    m.releaseVersion = value
}
// SetResourceUri sets the resourceUri property value. The 'self' reference for this resource.
func (m *V1beta1HypervisorManagersGetResponse_items) SetResourceUri(value *string)() {
    m.resourceUri = value
}
...
func (m *V1beta1HypervisorManagersGetResponse_items) SetServices(value []string)() {
    m.services = value
}
// SetStateReason sets the stateReason property value. Brief reason for the current state of the hypervisor manager
func (m *V1beta1HypervisorManagersGetResponse_items) SetStateReason(value *string)() {
    m.stateReason = value
}
// SetTypeEscaped sets the type property value. The type of resource.
func (m *V1beta1HypervisorManagersGetResponse_items) SetTypeEscaped(value *string)() {
    m.typeEscaped = value
}
...
func (m *V1beta1HypervisorManagersGetResponse_items) SetUid(value *string)() {
    m.uid = value
}
// SetUpdatedAt sets the updatedAt property value. Time in UTC at which the object was last updated
func (m *V1beta1HypervisorManagersGetResponse_items) SetUpdatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.updatedAt = value
}
...
func (m *V1beta1HypervisorManagersGetResponse_items) SetUsername(value *string)() {
    m.username = value
}
type V1beta1HypervisorManagersGetResponse_itemsable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetAppInfo()(V1beta1HypervisorManagersGetResponse_items_appInfoable)
    GetBuildVersion()(*string)
    GetCreatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)
    GetCustomerId()(*string)
    GetDataOrchestratorInfo()(V1beta1HypervisorManagersGetResponse_items_dataOrchestratorInfoable)
    GetDataServicesConnectorsInfo()([]V1beta1HypervisorManagersGetResponse_items_dataServicesConnectorsInfoable)
    ...
    GetUsername()(*string)
    SetAppInfo(value V1beta1HypervisorManagersGetResponse_items_appInfoable)()
    SetBuildVersion(value *string)()
    SetCreatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)()
    SetCustomerId(value *string)()
    SetDataOrchestratorInfo(value V1beta1HypervisorManagersGetResponse_items_dataOrchestratorInfoable)()
    SetDataServicesConnectorsInfo(value []V1beta1HypervisorManagersGetResponse_items_dataServicesConnectorsInfoable)()
