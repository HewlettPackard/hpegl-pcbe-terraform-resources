...
// V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo virtual machine performance metrics.
type V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo struct {
...
// NewV1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo instantiates a new V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo and sets the default values.
func NewV1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo()(*V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) {
    m := &V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfoFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfoFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetAverageReadLatency gets the averageReadLatency property value. Average read latency.
// returns a *int64 when successful
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) GetAverageReadLatency()(*int64) {
    return m.averageReadLatency
}
// GetAverageWriteLatency gets the averageWriteLatency property value. Average write latency.
// returns a *int64 when successful
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) GetAverageWriteLatency()(*int64) {
    return m.averageWriteLatency
}
// GetCpuAllocatedInMhz gets the cpuAllocatedInMhz property value. CPU allocated in mega hertz.
// returns a *int64 when successful
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) GetCpuAllocatedInMhz()(*int64) {
    return m.cpuAllocatedInMhz
}
// GetCpuUsedInMhz gets the cpuUsedInMhz property value. CPU used in mega hertz.
// returns a *int64 when successful
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) GetCpuUsedInMhz()(*int64) {
    return m.cpuUsedInMhz
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *int64 when successful
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) GetMemoryAllocatedInMb()(*int64) {
    return m.memoryAllocatedInMb
}
// GetMemoryUsedInMb gets the memoryUsedInMb property value. Memory used in mega bytes.
// returns a *int64 when successful
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) GetMemoryUsedInMb()(*int64) {
...
// returns a *int64 when successful
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) GetStorageAllocatedInKb()(*int64) {
    return m.storageAllocatedInKb
}
// GetStorageUsedInBytes gets the storageUsedInBytes property value. Storage used in bytes.
// returns a *int64 when successful
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) GetStorageUsedInBytes()(*int64) {
    return m.storageUsedInBytes
}
// GetTotalReadIops gets the totalReadIops property value. Total read IOPS.
// returns a *int64 when successful
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) GetTotalReadIops()(*int64) {
    return m.totalReadIops
}
// GetTotalWriteIops gets the totalWriteIops property value. Total write IOPS.
// returns a *int64 when successful
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) GetTotalWriteIops()(*int64) {
    return m.totalWriteIops
}
// Serialize serializes information the current object
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetAverageReadLatency sets the averageReadLatency property value. Average read latency.
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) SetAverageReadLatency(value *int64)() {
    m.averageReadLatency = value
}
// SetAverageWriteLatency sets the averageWriteLatency property value. Average write latency.
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) SetAverageWriteLatency(value *int64)() {
    m.averageWriteLatency = value
}
// SetCpuAllocatedInMhz sets the cpuAllocatedInMhz property value. CPU allocated in mega hertz.
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) SetCpuAllocatedInMhz(value *int64)() {
    m.cpuAllocatedInMhz = value
}
// SetCpuUsedInMhz sets the cpuUsedInMhz property value. CPU used in mega hertz.
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) SetCpuUsedInMhz(value *int64)() {
    m.cpuUsedInMhz = value
}
// SetMemoryAllocatedInMb sets the memoryAllocatedInMb property value. Memory allocated in mega bytes.
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) SetMemoryAllocatedInMb(value *int64)() {
    m.memoryAllocatedInMb = value
}
// SetMemoryUsedInMb sets the memoryUsedInMb property value. Memory used in mega bytes.
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) SetMemoryUsedInMb(value *int64)() {
...
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) SetStorageAllocatedInKb(value *int64)() {
    m.storageAllocatedInKb = value
}
// SetStorageUsedInBytes sets the storageUsedInBytes property value. Storage used in bytes.
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) SetStorageUsedInBytes(value *int64)() {
    m.storageUsedInBytes = value
}
// SetTotalReadIops sets the totalReadIops property value. Total read IOPS.
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) SetTotalReadIops(value *int64)() {
    m.totalReadIops = value
}
// SetTotalWriteIops sets the totalWriteIops property value. Total write IOPS.
func (m *V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfo) SetTotalWriteIops(value *int64)() {
    m.totalWriteIops = value
}
type V1beta1VirtualMachinesItemVirtualMachinesGetResponse_vmPerfMetricInfoable interface {
