...
// V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo hypervisor cluster performance metrics.
type V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo struct {
...
// NewV1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo instantiates a new V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo and sets the default values.
func NewV1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo()(*V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo) {
    m := &V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfoFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfoFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetCpuCapacityInMhz gets the cpuCapacityInMhz property value. CPU allocated in mega hertz.
// returns a *int64 when successful
func (m *V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo) GetCpuCapacityInMhz()(*int64) {
    return m.cpuCapacityInMhz
}
// GetCpuUsageInMhz gets the cpuUsageInMhz property value. CPU used in mega hertz.
// returns a *int64 when successful
func (m *V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo) GetCpuUsageInMhz()(*int64) {
    return m.cpuUsageInMhz
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *int64 when successful
func (m *V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo) GetMemorySizeInBytes()(*int64) {
    return m.memorySizeInBytes
}
// GetMemoryUsageInMb gets the memoryUsageInMb property value. Memory used in mega bytes.
// returns a *int64 when successful
func (m *V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo) GetMemoryUsageInMb()(*int64) {
    return m.memoryUsageInMb
}
// GetTotalStorageInBytes gets the totalStorageInBytes property value. Storage allocated in bytes.
// returns a *int64 when successful
func (m *V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo) GetTotalStorageInBytes()(*int64) {
    return m.totalStorageInBytes
}
// GetUsedStorageInBytes gets the usedStorageInBytes property value. Storage used in bytes.
// returns a *int64 when successful
func (m *V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo) GetUsedStorageInBytes()(*int64) {
    return m.usedStorageInBytes
}
// Serialize serializes information the current object
func (m *V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetCpuCapacityInMhz sets the cpuCapacityInMhz property value. CPU allocated in mega hertz.
func (m *V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo) SetCpuCapacityInMhz(value *int64)() {
    m.cpuCapacityInMhz = value
}
// SetCpuUsageInMhz sets the cpuUsageInMhz property value. CPU used in mega hertz.
func (m *V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo) SetCpuUsageInMhz(value *int64)() {
    m.cpuUsageInMhz = value
}
// SetMemorySizeInBytes sets the memorySizeInBytes property value. Memory allocated in bytes.
func (m *V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo) SetMemorySizeInBytes(value *int64)() {
    m.memorySizeInBytes = value
}
// SetMemoryUsageInMb sets the memoryUsageInMb property value. Memory used in mega bytes.
func (m *V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo) SetMemoryUsageInMb(value *int64)() {
    m.memoryUsageInMb = value
}
// SetTotalStorageInBytes sets the totalStorageInBytes property value. Storage allocated in bytes.
func (m *V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo) SetTotalStorageInBytes(value *int64)() {
    m.totalStorageInBytes = value
}
// SetUsedStorageInBytes sets the usedStorageInBytes property value. Storage used in bytes.
func (m *V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfo) SetUsedStorageInBytes(value *int64)() {
    m.usedStorageInBytes = value
}
type V1beta1HypervisorClustersItemClusterGetResponse_clusterPerfMetricInfoable interface {
