...
// V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo hypervisor host performance metrics.
type V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo struct {
...
// NewV1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo instantiates a new V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo and sets the default values.
func NewV1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo()(*V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo) {
    m := &V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfoFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfoFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetCpuCapacityInHz gets the cpuCapacityInHz property value. CPU allocated in hertz.
// returns a *int64 when successful
func (m *V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo) GetCpuCapacityInHz()(*int64) {
    return m.cpuCapacityInHz
}
// GetCpuUsageInMhz gets the cpuUsageInMhz property value. CPU used in mega hertz.
// returns a *int64 when successful
func (m *V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo) GetCpuUsageInMhz()(*int64) {
    return m.cpuUsageInMhz
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *int64 when successful
func (m *V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo) GetMemorySizeInBytes()(*int64) {
    return m.memorySizeInBytes
}
// GetMemoryUsageInMb gets the memoryUsageInMb property value. Memory used in mega bytes.
// returns a *int64 when successful
func (m *V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo) GetMemoryUsageInMb()(*int64) {
    return m.memoryUsageInMb
}
// GetTotalStorageInBytes gets the totalStorageInBytes property value. Storage allocated in bytes.
// returns a *int64 when successful
func (m *V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo) GetTotalStorageInBytes()(*int64) {
    return m.totalStorageInBytes
}
// GetUsedStorageInBytes gets the usedStorageInBytes property value. Storage used in bytes.
// returns a *int64 when successful
func (m *V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo) GetUsedStorageInBytes()(*int64) {
    return m.usedStorageInBytes
}
// Serialize serializes information the current object
func (m *V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetCpuCapacityInHz sets the cpuCapacityInHz property value. CPU allocated in hertz.
func (m *V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo) SetCpuCapacityInHz(value *int64)() {
    m.cpuCapacityInHz = value
}
// SetCpuUsageInMhz sets the cpuUsageInMhz property value. CPU used in mega hertz.
func (m *V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo) SetCpuUsageInMhz(value *int64)() {
    m.cpuUsageInMhz = value
}
// SetMemorySizeInBytes sets the memorySizeInBytes property value. Memory allocated in bytes.
func (m *V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo) SetMemorySizeInBytes(value *int64)() {
    m.memorySizeInBytes = value
}
// SetMemoryUsageInMb sets the memoryUsageInMb property value. Memory used in mega bytes.
func (m *V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo) SetMemoryUsageInMb(value *int64)() {
    m.memoryUsageInMb = value
}
// SetTotalStorageInBytes sets the totalStorageInBytes property value. Storage allocated in bytes.
func (m *V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo) SetTotalStorageInBytes(value *int64)() {
    m.totalStorageInBytes = value
}
// SetUsedStorageInBytes sets the usedStorageInBytes property value. Storage used in bytes.
func (m *V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfo) SetUsedStorageInBytes(value *int64)() {
    m.usedStorageInBytes = value
}
type V1beta1HypervisorHostsGetResponse_items_hostPerfMetricInfoable interface {
