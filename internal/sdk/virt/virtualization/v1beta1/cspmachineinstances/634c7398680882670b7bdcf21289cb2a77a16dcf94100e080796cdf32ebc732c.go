...
func (i CspMachineInstancesGetResponse_items_protectionJobInfo_scheduleInfo_status) String() string {
...
func ParseCspMachineInstancesGetResponse_items_protectionJobInfo_scheduleInfo_status(v string) (any, error) {
    result := NOT_RUN_CSPMACHINEINSTANCESGETRESPONSE_ITEMS_PROTECTIONJOBINFO_SCHEDULEINFO_STATUS
    switch v {
        case "NOT_RUN":
            result = NOT_RUN_CSPMACHINEINSTANCESGETRESPONSE_ITEMS_PROTECTIONJOBINFO_SCHEDULEINFO_STATUS
        case "SUCCESS":
            result = SUCCESS_CSPMACHINEINSTANCESGETRESPONSE_ITEMS_PROTECTIONJOBINFO_SCHEDULEINFO_STATUS
        case "FAILURE":
            result = FAILURE_CSPMACHINEINSTANCESGETRESPONSE_ITEMS_PROTECTIONJOBINFO_SCHEDULEINFO_STATUS
        case "PAUSED":
            result = PAUSED_CSPMACHINEINSTANCESGETRESPONSE_ITEMS_PROTECTIONJOBINFO_SCHEDULEINFO_STATUS
        default:
            return nil, nil
    }
    return &result, nil
...
func (i CspMachineInstancesGetResponse_items_protectionJobInfo_scheduleInfo_status) isMultiValue() bool {
    return false
}
