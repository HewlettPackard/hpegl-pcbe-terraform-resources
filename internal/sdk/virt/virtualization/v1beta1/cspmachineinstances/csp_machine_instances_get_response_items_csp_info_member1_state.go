...
func (i CspMachineInstancesGetResponse_items_cspInfoMember1_state) String() string {
...
func ParseCspMachineInstancesGetResponse_items_cspInfoMember1_state(v string) (any, error) {
    result := UNKNOWN_CSPMACHINEINSTANCESGETRESPONSE_ITEMS_CSPINFOMEMBER1_STATE
    switch v {
        case "UNKNOWN":
            result = UNKNOWN_CSPMACHINEINSTANCESGETRESPONSE_ITEMS_CSPINFOMEMBER1_STATE
        case "PENDING":
            result = PENDING_CSPMACHINEINSTANCESGETRESPONSE_ITEMS_CSPINFOMEMBER1_STATE
        case "RUNNING":
            result = RUNNING_CSPMACHINEINSTANCESGETRESPONSE_ITEMS_CSPINFOMEMBER1_STATE
        case "SHUTTING_DOWN":
            result = SHUTTING_DOWN_CSPMACHINEINSTANCESGETRESPONSE_ITEMS_CSPINFOMEMBER1_STATE
        case "STOPPING":
            result = STOPPING_CSPMACHINEINSTANCESGETRESPONSE_ITEMS_CSPINFOMEMBER1_STATE
        case "STOPPED":
            result = STOPPED_CSPMACHINEINSTANCESGETRESPONSE_ITEMS_CSPINFOMEMBER1_STATE
        case "TERMINATED":
            result = TERMINATED_CSPMACHINEINSTANCESGETRESPONSE_ITEMS_CSPINFOMEMBER1_STATE
        default:
            return nil, nil
    }
    return &result, nil
...
func (i CspMachineInstancesGetResponse_items_cspInfoMember1_state) isMultiValue() bool {
    return false
}
