...
func ParseCspRdsInstancesGetResponse_items_protectionJobInfo_scheduleInfo_status(v string) (any, error) {
    result := NOT_RUN_CSPRDSINSTANCESGETRESPONSE_ITEMS_PROTECTIONJOBINFO_SCHEDULEINFO_STATUS
    switch v {
        case "NOT_RUN":
            result = NOT_RUN_CSPRDSINSTANCESGETRESPONSE_ITEMS_PROTECTIONJOBINFO_SCHEDULEINFO_STATUS
        case "SUCCESS":
            result = SUCCESS_CSPRDSINSTANCESGETRESPONSE_ITEMS_PROTECTIONJOBINFO_SCHEDULEINFO_STATUS
        case "FAILURE":
            result = FAILURE_CSPRDSINSTANCESGETRESPONSE_ITEMS_PROTECTIONJOBINFO_SCHEDULEINFO_STATUS
        case "PAUSED":
            result = PAUSED_CSPRDSINSTANCESGETRESPONSE_ITEMS_PROTECTIONJOBINFO_SCHEDULEINFO_STATUS
        default:
            return nil, nil
    }
    return &result, nil
...
func (i CspRdsInstancesGetResponse_items_protectionJobInfo_scheduleInfo_status) isMultiValue() bool {
    return false
}
