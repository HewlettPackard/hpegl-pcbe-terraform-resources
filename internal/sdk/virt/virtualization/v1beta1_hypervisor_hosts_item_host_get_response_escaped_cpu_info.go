...
// V1beta1HypervisorHostsItemHostGetResponse_cpuInfo cPU information.
type V1beta1HypervisorHostsItemHostGetResponse_cpuInfo struct {
...
// NewV1beta1HypervisorHostsItemHostGetResponse_cpuInfo instantiates a new V1beta1HypervisorHostsItemHostGetResponse_cpuInfo and sets the default values.
func NewV1beta1HypervisorHostsItemHostGetResponse_cpuInfo()(*V1beta1HypervisorHostsItemHostGetResponse_cpuInfo) {
    m := &V1beta1HypervisorHostsItemHostGetResponse_cpuInfo{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1HypervisorHostsItemHostGetResponse_cpuInfoFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1HypervisorHostsItemHostGetResponse_cpuInfoFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1HypervisorHostsItemHostGetResponse_cpuInfo(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse_cpuInfo) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse_cpuInfo) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *V1beta1HypervisorHostsItemHostGetResponse_cpuInfo) GetHyperthreadingActive()(*bool) {
...
func (m *V1beta1HypervisorHostsItemHostGetResponse_cpuInfo) GetLogicalProcessors()(*int32) {
    return m.logicalProcessors
}
// GetProcessorCores gets the processorCores property value. Number of processor cores.
// returns a *int32 when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse_cpuInfo) GetProcessorCores()(*int32) {
    return m.processorCores
}
// GetProcessorSockets gets the processorSockets property value. Number of processor sockets.
// returns a *int32 when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse_cpuInfo) GetProcessorSockets()(*int32) {
    return m.processorSockets
}
// GetProcessorSpeedHz gets the processorSpeedHz property value. Processor speed in Hz.
// returns a *int64 when successful
func (m *V1beta1HypervisorHostsItemHostGetResponse_cpuInfo) GetProcessorSpeedHz()(*int64) {
    return m.processorSpeedHz
}
// Serialize serializes information the current object
func (m *V1beta1HypervisorHostsItemHostGetResponse_cpuInfo) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1HypervisorHostsItemHostGetResponse_cpuInfo) SetAdditionalData(value map[string]any)() {
...
func (m *V1beta1HypervisorHostsItemHostGetResponse_cpuInfo) SetHyperthreadingActive(value *bool)() {
    m.hyperthreadingActive = value
}
// SetLogicalProcessors sets the logicalProcessors property value. Number of logical processors.
func (m *V1beta1HypervisorHostsItemHostGetResponse_cpuInfo) SetLogicalProcessors(value *int32)() {
    m.logicalProcessors = value
}
// SetProcessorCores sets the processorCores property value. Number of processor cores.
func (m *V1beta1HypervisorHostsItemHostGetResponse_cpuInfo) SetProcessorCores(value *int32)() {
    m.processorCores = value
}
// SetProcessorSockets sets the processorSockets property value. Number of processor sockets.
func (m *V1beta1HypervisorHostsItemHostGetResponse_cpuInfo) SetProcessorSockets(value *int32)() {
    m.processorSockets = value
}
// SetProcessorSpeedHz sets the processorSpeedHz property value. Processor speed in Hz.
func (m *V1beta1HypervisorHostsItemHostGetResponse_cpuInfo) SetProcessorSpeedHz(value *int64)() {
    m.processorSpeedHz = value
}
type V1beta1HypervisorHostsItemHostGetResponse_cpuInfoable interface {
