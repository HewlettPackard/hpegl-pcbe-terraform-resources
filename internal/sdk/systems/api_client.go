...
import (
    ...
    i613047b50302824637e34e608ae5d6c6ecad220cb65cb210507a87b8abe90b53 "github.com/HewlettPackard/hpegl-pcbe-terraform-resources/internal/sdk/systems/privatecloudbusiness"
)
...
func NewApiClient(requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ApiClient) {
    ...
    if m.BaseRequestBuilder.RequestAdapter.GetBaseUrl() == "" {
        m.BaseRequestBuilder.RequestAdapter.SetBaseUrl("https://127.0.0.1")
    }
    m.BaseRequestBuilder.PathParameters["baseurl"] = m.BaseRequestBuilder.RequestAdapter.GetBaseUrl()
    return m
}
// PrivateCloudBusiness the privateCloudBusiness property
// returns a *PrivateCloudBusinessRequestBuilder when successful
func (m *ApiClient) PrivateCloudBusiness()(*i613047b50302824637e34e608ae5d6c6ecad220cb65cb210507a87b8abe90b53.PrivateCloudBusinessRequestBuilder) {
    return i613047b50302824637e34e608ae5d6c6ecad220cb65cb210507a87b8abe90b53.NewPrivateCloudBusinessRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
