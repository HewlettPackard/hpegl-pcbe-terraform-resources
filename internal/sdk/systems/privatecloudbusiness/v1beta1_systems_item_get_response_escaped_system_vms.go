...
func NewV1beta1SystemsItemGetResponse_systemVms()(*V1beta1SystemsItemGetResponse_systemVms) {
    m := &V1beta1SystemsItemGetResponse_systemVms{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsItemGetResponse_systemVmsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1SystemsItemGetResponse_systemVmsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsItemGetResponse_systemVms(), nil
}
...
func (m *V1beta1SystemsItemGetResponse_systemVms) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *V1beta1SystemsItemGetResponse_systemVms) GetName()(*string) {
    return m.name
}
// GetUuid gets the uuid property value. Unique Identifier of the system virtual machine, usually a UUID.
// returns a *string when successful
func (m *V1beta1SystemsItemGetResponse_systemVms) GetUuid()(*string) {
    return m.uuid
}
// Serialize serializes information the current object
func (m *V1beta1SystemsItemGetResponse_systemVms) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemsItemGetResponse_systemVms) SetName(value *string)() {
    m.name = value
}
// SetUuid sets the uuid property value. Unique Identifier of the system virtual machine, usually a UUID.
func (m *V1beta1SystemsItemGetResponse_systemVms) SetUuid(value *string)() {
    m.uuid = value
}
type V1beta1SystemsItemGetResponse_systemVmsable interface {
