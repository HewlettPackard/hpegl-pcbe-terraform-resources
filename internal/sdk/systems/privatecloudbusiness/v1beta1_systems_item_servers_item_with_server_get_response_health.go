...
func NewV1beta1SystemsItemServersItemWithServerGetResponse_health()(*V1beta1SystemsItemServersItemWithServerGetResponse_health) {
    m := &V1beta1SystemsItemServersItemWithServerGetResponse_health{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsItemServersItemWithServerGetResponse_healthFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateV1beta1SystemsItemServersItemWithServerGetResponse_healthFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsItemServersItemWithServerGetResponse_health(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_health) GetAdditionalData()(map[string]any) {
...
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_health) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *string when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_health) GetHbLastUpdateTimestamp()(*string) {
    return m.hbLastUpdateTimestamp
}
// GetPowerState gets the powerState property value. The powerState property
// returns a *string when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_health) GetPowerState()(*string) {
    return m.powerState
}
// Serialize serializes information the current object
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_health) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_health) SetAdditionalData(value map[string]any)() {
...
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_health) SetPowerState(value *string)() {
    m.powerState = value
}
