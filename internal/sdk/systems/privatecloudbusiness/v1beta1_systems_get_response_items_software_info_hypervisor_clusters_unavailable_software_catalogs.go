...
func NewV1beta1SystemsGetResponse_items_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogs()(*V1beta1SystemsGetResponse_items_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogs) {
    m := &V1beta1SystemsGetResponse_items_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogs{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsGetResponse_items_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateV1beta1SystemsGetResponse_items_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsGetResponse_items_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogs(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1SystemsGetResponse_items_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogs) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1SystemsGetResponse_items_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogs) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *V1beta1SystemsGetResponse_items_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogs) GetReasons()([]string) {
    return m.reasons
}
// Serialize serializes information the current object
func (m *V1beta1SystemsGetResponse_items_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogs) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    if m.GetReasons() != nil {
...
func (m *V1beta1SystemsGetResponse_items_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogs) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetReasons sets the reasons property value. Reasons why this catalog is unavailable for update
func (m *V1beta1SystemsGetResponse_items_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogs) SetReasons(value []string)() {
    m.reasons = value
}
type V1beta1SystemsGetResponse_items_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogsable interface {
