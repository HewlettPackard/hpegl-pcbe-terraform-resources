...
func NewV1beta1SystemsGetResponse_items_systemVms()(*V1beta1SystemsGetResponse_items_systemVms) {
    m := &V1beta1SystemsGetResponse_items_systemVms{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsGetResponse_items_systemVmsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1SystemsGetResponse_items_systemVmsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsGetResponse_items_systemVms(), nil
}
...
func (m *V1beta1SystemsGetResponse_items_systemVms) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *V1beta1SystemsGetResponse_items_systemVms) GetName()(*string) {
    return m.name
}
// GetUuid gets the uuid property value. Unique Identifier of the system virtual machine, usually a UUID.
// returns a *string when successful
func (m *V1beta1SystemsGetResponse_items_systemVms) GetUuid()(*string) {
    return m.uuid
}
// Serialize serializes information the current object
func (m *V1beta1SystemsGetResponse_items_systemVms) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemsGetResponse_items_systemVms) SetName(value *string)() {
    m.name = value
}
// SetUuid sets the uuid property value. Unique Identifier of the system virtual machine, usually a UUID.
func (m *V1beta1SystemsGetResponse_items_systemVms) SetUuid(value *string)() {
    m.uuid = value
}
type V1beta1SystemsGetResponse_items_systemVmsable interface {
