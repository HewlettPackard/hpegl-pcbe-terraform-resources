...
func NewV1beta1SystemsGetResponse_items_associatedResourceCounts()(*V1beta1SystemsGetResponse_items_associatedResourceCounts) {
    m := &V1beta1SystemsGetResponse_items_associatedResourceCounts{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsGetResponse_items_associatedResourceCountsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateV1beta1SystemsGetResponse_items_associatedResourceCountsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsGetResponse_items_associatedResourceCounts(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1SystemsGetResponse_items_associatedResourceCounts) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetDatastoreCount gets the datastoreCount property value. Total Datastore Count of the system
// returns a *float64 when successful
func (m *V1beta1SystemsGetResponse_items_associatedResourceCounts) GetDatastoreCount()(*float64) {
    return m.datastoreCount
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1SystemsGetResponse_items_associatedResourceCounts) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *float64 when successful
func (m *V1beta1SystemsGetResponse_items_associatedResourceCounts) GetServersCount()(*float64) {
...
// returns a *float64 when successful
func (m *V1beta1SystemsGetResponse_items_associatedResourceCounts) GetStorageArrayCount()(*float64) {
    return m.storageArrayCount
}
// GetSwitchesCount gets the switchesCount property value. Total Switches Count of the system
// returns a *float64 when successful
func (m *V1beta1SystemsGetResponse_items_associatedResourceCounts) GetSwitchesCount()(*float64) {
    return m.switchesCount
}
// GetVmCount gets the vmCount property value. Total Virtual Machine Count of the system
// returns a *float64 when successful
func (m *V1beta1SystemsGetResponse_items_associatedResourceCounts) GetVmCount()(*float64) {
    return m.vmCount
}
// Serialize serializes information the current object
func (m *V1beta1SystemsGetResponse_items_associatedResourceCounts) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemsGetResponse_items_associatedResourceCounts) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetDatastoreCount sets the datastoreCount property value. Total Datastore Count of the system
func (m *V1beta1SystemsGetResponse_items_associatedResourceCounts) SetDatastoreCount(value *float64)() {
...
func (m *V1beta1SystemsGetResponse_items_associatedResourceCounts) SetServersCount(value *float64)() {
...
func (m *V1beta1SystemsGetResponse_items_associatedResourceCounts) SetSwitchesCount(value *float64)() {
    m.switchesCount = value
}
// SetVmCount sets the vmCount property value. Total Virtual Machine Count of the system
func (m *V1beta1SystemsGetResponse_items_associatedResourceCounts) SetVmCount(value *float64)() {
    m.vmCount = value
}
