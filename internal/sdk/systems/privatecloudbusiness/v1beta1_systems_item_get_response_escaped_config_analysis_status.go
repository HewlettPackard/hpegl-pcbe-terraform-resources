...
func NewV1beta1SystemsItemGetResponse_configAnalysisStatus()(*V1beta1SystemsItemGetResponse_configAnalysisStatus) {
    m := &V1beta1SystemsItemGetResponse_configAnalysisStatus{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsItemGetResponse_configAnalysisStatusFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateV1beta1SystemsItemGetResponse_configAnalysisStatusFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsItemGetResponse_configAnalysisStatus(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1SystemsItemGetResponse_configAnalysisStatus) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetCreatedAt gets the createdAt property value. Time when configuration analysis job was created.
// returns a *string when successful
func (m *V1beta1SystemsItemGetResponse_configAnalysisStatus) GetCreatedAt()(*string) {
    return m.createdAt
}
// GetCreatedBy gets the createdBy property value. Configuration analysis job was created by.
// returns a *string when successful
func (m *V1beta1SystemsItemGetResponse_configAnalysisStatus) GetCreatedBy()(*string) {
    return m.createdBy
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1SystemsItemGetResponse_configAnalysisStatus) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *string when successful
func (m *V1beta1SystemsItemGetResponse_configAnalysisStatus) GetRuleRunStartTime()(*string) {
    return m.ruleRunStartTime
}
// GetTotalFailed gets the totalFailed property value. Count of failed checks.
// returns a *float64 when successful
func (m *V1beta1SystemsItemGetResponse_configAnalysisStatus) GetTotalFailed()(*float64) {
    return m.totalFailed
}
// GetTotalPassed gets the totalPassed property value. Count of passed checks.
// returns a *float64 when successful
func (m *V1beta1SystemsItemGetResponse_configAnalysisStatus) GetTotalPassed()(*float64) {
    return m.totalPassed
}
// GetTotalWarning gets the totalWarning property value. Count of warning checks.
// returns a *float64 when successful
func (m *V1beta1SystemsItemGetResponse_configAnalysisStatus) GetTotalWarning()(*float64) {
    return m.totalWarning
}
// Serialize serializes information the current object
func (m *V1beta1SystemsItemGetResponse_configAnalysisStatus) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemsItemGetResponse_configAnalysisStatus) SetCreatedAt(value *string)() {
    m.createdAt = value
}
// SetCreatedBy sets the createdBy property value. Configuration analysis job was created by.
func (m *V1beta1SystemsItemGetResponse_configAnalysisStatus) SetCreatedBy(value *string)() {
    m.createdBy = value
}
...
func (m *V1beta1SystemsItemGetResponse_configAnalysisStatus) SetTotalFailed(value *float64)() {
    m.totalFailed = value
}
// SetTotalPassed sets the totalPassed property value. Count of passed checks.
func (m *V1beta1SystemsItemGetResponse_configAnalysisStatus) SetTotalPassed(value *float64)() {
    m.totalPassed = value
}
// SetTotalWarning sets the totalWarning property value. Count of warning checks.
func (m *V1beta1SystemsItemGetResponse_configAnalysisStatus) SetTotalWarning(value *float64)() {
