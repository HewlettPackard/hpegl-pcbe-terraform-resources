...
const (
    UP_TO_DATE_GETRESPONSE_SOFTWAREINFO_HYPERVISORCLUSTERS_CURRENTUPDATESTATUS_STATE GetResponse_softwareInfo_hypervisorClusters_currentUpdateStatus_state = iota
    UPDATE_AVAILABLE_GETRESPONSE_SOFTWAREINFO_HYPERVISORCLUSTERS_CURRENTUPDATESTATUS_STATE
    PENDING_GETRESPONSE_SOFTWAREINFO_HYPERVISORCLUSTERS_CURRENTUPDATESTATUS_STATE
    ...
    NOT_READY_GETRESPONSE_SOFTWAREINFO_HYPERVISORCLUSTERS_CURRENTUPDATESTATUS_STATE
)
...
func ParseGetResponse_softwareInfo_hypervisorClusters_currentUpdateStatus_state(v string) (any, error) {
    ...
    switch v {
        ...
        case "UPDATE_AVAILABLE":
            result = UPDATE_AVAILABLE_GETRESPONSE_SOFTWAREINFO_HYPERVISORCLUSTERS_CURRENTUPDATESTATUS_STATE
        case "PENDING":
            result = PENDING_GETRESPONSE_SOFTWAREINFO_HYPERVISORCLUSTERS_CURRENTUPDATESTATUS_STATE
        case "PRECHECK_IN_PROGRESS":
            result = PRECHECK_IN_PROGRESS_GETRESPONSE_SOFTWAREINFO_HYPERVISORCLUSTERS_CURRENTUPDATESTATUS_STATE
        ...
        case "UPDATE_COMPLETE":
            result = UPDATE_COMPLETE_GETRESPONSE_SOFTWAREINFO_HYPERVISORCLUSTERS_CURRENTUPDATESTATUS_STATE
        case "UPDATE_FAILED":
            result = UPDATE_FAILED_GETRESPONSE_SOFTWAREINFO_HYPERVISORCLUSTERS_CURRENTUPDATESTATUS_STATE
        case "NOT_READY":
            result = NOT_READY_GETRESPONSE_SOFTWAREINFO_HYPERVISORCLUSTERS_CURRENTUPDATESTATUS_STATE
        default:
            return nil, nil
    }
    return &result, nil
}
func SerializeGetResponse_softwareInfo_hypervisorClusters_currentUpdateStatus_state(values []GetResponse_softwareInfo_hypervisorClusters_currentUpdateStatus_state) []string {
...
func (i GetResponse_softwareInfo_hypervisorClusters_currentUpdateStatus_state) isMultiValue() bool {
    return false
}
