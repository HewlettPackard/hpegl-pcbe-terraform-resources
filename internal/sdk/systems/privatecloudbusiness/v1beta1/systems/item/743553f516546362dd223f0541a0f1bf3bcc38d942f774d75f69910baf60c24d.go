...
const (
    ...
    DOWNLOAD_IN_PROGRESS_PATCHRESPONSE_SOFTWAREINFO_HYPERVISORCLUSTERS_CURRENTUPDATESTATUS_STATE
    DOWNLOAD_FAILED_PATCHRESPONSE_SOFTWAREINFO_HYPERVISORCLUSTERS_CURRENTUPDATESTATUS_STATE
    DOWNLOAD_COMPLETE_PATCHRESPONSE_SOFTWAREINFO_HYPERVISORCLUSTERS_CURRENTUPDATESTATUS_STATE
...
func ParsePatchResponse_softwareInfo_hypervisorClusters_currentUpdateStatus_state(v string) (any, error) {
    ...
    switch v {
        ...
        case "DOWNLOAD_IN_PROGRESS":
            result = DOWNLOAD_IN_PROGRESS_PATCHRESPONSE_SOFTWAREINFO_HYPERVISORCLUSTERS_CURRENTUPDATESTATUS_STATE
        case "DOWNLOAD_FAILED":
            result = DOWNLOAD_FAILED_PATCHRESPONSE_SOFTWAREINFO_HYPERVISORCLUSTERS_CURRENTUPDATESTATUS_STATE
        case "DOWNLOAD_COMPLETE":
            result = DOWNLOAD_COMPLETE_PATCHRESPONSE_SOFTWAREINFO_HYPERVISORCLUSTERS_CURRENTUPDATESTATUS_STATE
