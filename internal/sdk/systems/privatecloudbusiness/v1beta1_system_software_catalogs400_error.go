...
func NewV1beta1SystemSoftwareCatalogs400Error()(*V1beta1SystemSoftwareCatalogs400Error) {
    m := &V1beta1SystemSoftwareCatalogs400Error{
        ApiError: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewApiError(),
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemSoftwareCatalogs400ErrorFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1SystemSoftwareCatalogs400ErrorFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemSoftwareCatalogs400Error(), nil
}
// Error the primary error message.
// returns a string when successful
func (m *V1beta1SystemSoftwareCatalogs400Error) Error()(string) {
...
// returns a *string when successful
func (m *V1beta1SystemSoftwareCatalogs400Error) GetDebugId()(*string) {
    return m.debugId
}
...
func (m *V1beta1SystemSoftwareCatalogs400Error) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *string when successful
func (m *V1beta1SystemSoftwareCatalogs400Error) GetMessage()(*string) {
    return m.message
}
// Serialize serializes information the current object
func (m *V1beta1SystemSoftwareCatalogs400Error) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
