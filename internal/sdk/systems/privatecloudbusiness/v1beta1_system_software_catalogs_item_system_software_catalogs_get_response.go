...
type V1beta1SystemSoftwareCatalogsItemSystemSoftwareCatalogsGetResponse struct {
    ...
    aiEssentials V1beta1SystemSoftwareCatalogsItemSystemSoftwareCatalogsGetResponse_aiEssentialsable
...
// returns a V1beta1SystemSoftwareCatalogsItemSystemSoftwareCatalogsGetResponse_aiEssentialsable when successful
func (m *V1beta1SystemSoftwareCatalogsItemSystemSoftwareCatalogsGetResponse) GetAiEssentials()(V1beta1SystemSoftwareCatalogsItemSystemSoftwareCatalogsGetResponse_aiEssentialsable) {
...
func (m *V1beta1SystemSoftwareCatalogsItemSystemSoftwareCatalogsGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["aiEssentials"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1SystemSoftwareCatalogsItemSystemSoftwareCatalogsGetResponse_aiEssentialsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetAiEssentials(val.(V1beta1SystemSoftwareCatalogsItemSystemSoftwareCatalogsGetResponse_aiEssentialsable))
        }
        return nil
    }
...
func (m *V1beta1SystemSoftwareCatalogsItemSystemSoftwareCatalogsGetResponse) SetAiEssentials(value V1beta1SystemSoftwareCatalogsItemSystemSoftwareCatalogsGetResponse_aiEssentialsable)() {
...
type V1beta1SystemSoftwareCatalogsItemSystemSoftwareCatalogsGetResponseable interface {
    ...
    GetAiEssentials()(V1beta1SystemSoftwareCatalogsItemSystemSoftwareCatalogsGetResponse_aiEssentialsable)
    ...
    GetVersion()(*string)
    SetAiEssentials(value V1beta1SystemSoftwareCatalogsItemSystemSoftwareCatalogsGetResponse_aiEssentialsable)()
