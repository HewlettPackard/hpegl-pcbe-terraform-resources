...
type V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo struct {
    ...
    networkInterfaces []V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo_networkInterfacesable
...
func NewV1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo()(*V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo) {
    m := &V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfoFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateV1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfoFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["networkInterfaces"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo_networkInterfacesFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo_networkInterfacesable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo_networkInterfacesable)
                }
            }
...
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo) GetGateway()(*string) {
    return m.gateway
}
// GetIloHostname gets the iloHostname property value. iLO Hostname
// returns a *string when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo) GetIloHostname()(*string) {
    return m.iloHostname
}
// GetIloIp gets the iloIp property value. iLO Management IP address
// returns a *string when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo) GetIloIp()(*string) {
    return m.iloIp
}
// GetNetwork gets the network property value. The network property
// returns a *string when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo) GetNetwork()(*string) {
    return m.network
}
// GetNetworkInterfaces gets the networkInterfaces property value. List of iLO network interfaces
// returns a []V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo_networkInterfacesable when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo) GetNetworkInterfaces()([]V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo_networkInterfacesable) {
    return m.networkInterfaces
}
// GetSubnetMask gets the subnetMask property value. The subnetMask property
// returns a *string when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo) GetSubnetMask()(*string) {
    return m.subnetMask
}
// Serialize serializes information the current object
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetGateway sets the gateway property value. The gateway property
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo) SetGateway(value *string)() {
    m.gateway = value
}
// SetIloHostname sets the iloHostname property value. iLO Hostname
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo) SetIloHostname(value *string)() {
    m.iloHostname = value
}
// SetIloIp sets the iloIp property value. iLO Management IP address
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo) SetIloIp(value *string)() {
    m.iloIp = value
}
// SetNetwork sets the network property value. The network property
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo) SetNetwork(value *string)() {
    m.network = value
}
// SetNetworkInterfaces sets the networkInterfaces property value. List of iLO network interfaces
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo) SetNetworkInterfaces(value []V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo_networkInterfacesable)() {
    m.networkInterfaces = value
}
// SetSubnetMask sets the subnetMask property value. The subnetMask property
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_iloNetworkInfo) SetSubnetMask(value *string)() {
    m.subnetMask = value
}
