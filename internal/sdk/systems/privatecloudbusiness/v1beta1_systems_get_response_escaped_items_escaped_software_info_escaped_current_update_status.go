...
func NewV1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatus()(*V1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatus) {
    m := &V1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatus{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatusFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateV1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatusFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatus(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatus) GetAdditionalData()(map[string]any) {
...
func (m *V1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatus) GetCatalogVersion()(*string) {
    return m.catalogVersion
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatus) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *string when successful
func (m *V1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatus) GetParentTaskUri()(*string) {
    return m.parentTaskUri
}
// GetPercentage gets the percentage property value. Percentage of the software update progress.
// returns a *int32 when successful
func (m *V1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatus) GetPercentage()(*int32) {
    return m.percentage
}
...
// returns a *string when successful
func (m *V1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatus) GetTaskUri()(*string) {
    return m.taskUri
}
// Serialize serializes information the current object
func (m *V1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatus) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatus) SetAdditionalData(value map[string]any)() {
...
func (m *V1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatus) SetCatalogVersion(value *string)() {
...
func (m *V1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatus) SetParentTaskUri(value *string)() {
    m.parentTaskUri = value
}
// SetPercentage sets the percentage property value. Percentage of the software update progress.
func (m *V1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatus) SetPercentage(value *int32)() {
    m.percentage = value
}
...
func (m *V1beta1SystemsGetResponse_items_softwareInfo_currentUpdateStatus) SetTaskUri(value *string)() {
    m.taskUri = value
}
