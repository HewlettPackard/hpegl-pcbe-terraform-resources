...
func NewV1beta1SystemsItemServersGetResponse_items_iloNetworkInfo_networkInterfaces()(*V1beta1SystemsItemServersGetResponse_items_iloNetworkInfo_networkInterfaces) {
    m := &V1beta1SystemsItemServersGetResponse_items_iloNetworkInfo_networkInterfaces{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsItemServersGetResponse_items_iloNetworkInfo_networkInterfacesFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateV1beta1SystemsItemServersGetResponse_items_iloNetworkInfo_networkInterfacesFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsItemServersGetResponse_items_iloNetworkInfo_networkInterfaces(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1SystemsItemServersGetResponse_items_iloNetworkInfo_networkInterfaces) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1SystemsItemServersGetResponse_items_iloNetworkInfo_networkInterfaces) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *V1beta1SystemsItemServersGetResponse_items_iloNetworkInfo_networkInterfaces) GetMacAddress()(*string) {
    return m.macAddress
}
// GetSpeedGbps gets the speedGbps property value. speed
// returns a *float64 when successful
func (m *V1beta1SystemsItemServersGetResponse_items_iloNetworkInfo_networkInterfaces) GetSpeedGbps()(*float64) {
    return m.speedGbps
}
// Serialize serializes information the current object
func (m *V1beta1SystemsItemServersGetResponse_items_iloNetworkInfo_networkInterfaces) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemsItemServersGetResponse_items_iloNetworkInfo_networkInterfaces) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetMacAddress sets the macAddress property value. MAC address
func (m *V1beta1SystemsItemServersGetResponse_items_iloNetworkInfo_networkInterfaces) SetMacAddress(value *string)() {
    m.macAddress = value
}
// SetSpeedGbps sets the speedGbps property value. speed
func (m *V1beta1SystemsItemServersGetResponse_items_iloNetworkInfo_networkInterfaces) SetSpeedGbps(value *float64)() {
    m.speedGbps = value
}
