...
// V1beta1SystemsItemServersGetResponse_items_gpus gPU information.
type V1beta1SystemsItemServersGetResponse_items_gpus struct {
...
// NewV1beta1SystemsItemServersGetResponse_items_gpus instantiates a new V1beta1SystemsItemServersGetResponse_items_gpus and sets the default values.
func NewV1beta1SystemsItemServersGetResponse_items_gpus()(*V1beta1SystemsItemServersGetResponse_items_gpus) {
    m := &V1beta1SystemsItemServersGetResponse_items_gpus{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsItemServersGetResponse_items_gpusFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1SystemsItemServersGetResponse_items_gpusFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsItemServersGetResponse_items_gpus(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetBdf gets the bdf property value. Bus/Driver/Function information.
// returns a *string when successful
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) GetBdf()(*string) {
    return m.bdf
}
// GetDriverVersion gets the driverVersion property value. The driverVersion property
// returns a *string when successful
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) GetDriverVersion()(*string) {
    return m.driverVersion
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) GetMemoryFreeBytes()(*float64) {
    return m.memoryFreeBytes
}
// GetMemoryTotalBytes gets the memoryTotalBytes property value. The memoryTotalBytes property
// returns a *float64 when successful
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) GetMemoryTotalBytes()(*float64) {
    return m.memoryTotalBytes
}
// GetMemoryUsedBytes gets the memoryUsedBytes property value. The memoryUsedBytes property
// returns a *float64 when successful
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) GetMemoryUsedBytes()(*float64) {
    return m.memoryUsedBytes
}
// GetName gets the name property value. The name property
// returns a *string when successful
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) GetName()(*string) {
    return m.name
}
// GetVbiosVersion gets the vbiosVersion property value. The vbiosVersion property
// returns a *string when successful
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) GetVbiosVersion()(*string) {
    return m.vbiosVersion
}
// Serialize serializes information the current object
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetBdf sets the bdf property value. Bus/Driver/Function information.
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) SetBdf(value *string)() {
    m.bdf = value
}
// SetDriverVersion sets the driverVersion property value. The driverVersion property
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) SetDriverVersion(value *string)() {
    m.driverVersion = value
}
// SetMemoryFreeBytes sets the memoryFreeBytes property value. The memoryFreeBytes property
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) SetMemoryFreeBytes(value *float64)() {
    m.memoryFreeBytes = value
}
// SetMemoryTotalBytes sets the memoryTotalBytes property value. The memoryTotalBytes property
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) SetMemoryTotalBytes(value *float64)() {
    m.memoryTotalBytes = value
}
// SetMemoryUsedBytes sets the memoryUsedBytes property value. The memoryUsedBytes property
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) SetMemoryUsedBytes(value *float64)() {
    m.memoryUsedBytes = value
}
// SetName sets the name property value. The name property
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) SetName(value *string)() {
    m.name = value
}
// SetVbiosVersion sets the vbiosVersion property value. The vbiosVersion property
func (m *V1beta1SystemsItemServersGetResponse_items_gpus) SetVbiosVersion(value *string)() {
    m.vbiosVersion = value
}
type V1beta1SystemsItemServersGetResponse_items_gpusable interface {
