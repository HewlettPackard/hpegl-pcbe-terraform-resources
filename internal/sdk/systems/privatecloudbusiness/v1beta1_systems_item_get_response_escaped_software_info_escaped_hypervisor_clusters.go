...
type V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters struct {
    ...
    availableSoftwareCatalogs []V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_availableSoftwareCatalogsable
    ...
    currentSoftwareCatalog V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_currentSoftwareCatalogable
    // Details of the current software update status
    currentUpdateStatus V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_currentUpdateStatusable
    ...
    unavailableSoftwareCatalogs []V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogsable
}
...
func NewV1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters()(*V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) {
    m := &V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsItemGetResponse_softwareInfo_hypervisorClustersFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateV1beta1SystemsItemGetResponse_softwareInfo_hypervisorClustersFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) GetAdditionalData()(map[string]any) {
...
// returns a []V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_availableSoftwareCatalogsable when successful
func (m *V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) GetAvailableSoftwareCatalogs()([]V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_availableSoftwareCatalogsable) {
...
// returns a V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_currentSoftwareCatalogable when successful
func (m *V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) GetCurrentSoftwareCatalog()(V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_currentSoftwareCatalogable) {
...
// returns a V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_currentUpdateStatusable when successful
func (m *V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) GetCurrentUpdateStatus()(V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_currentUpdateStatusable) {
    return m.currentUpdateStatus
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["availableSoftwareCatalogs"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_availableSoftwareCatalogsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_availableSoftwareCatalogsable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_availableSoftwareCatalogsable)
                }
            }
    ...
    res["currentSoftwareCatalog"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_currentSoftwareCatalogFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetCurrentSoftwareCatalog(val.(V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_currentSoftwareCatalogable))
        }
        return nil
    }
    res["currentUpdateStatus"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_currentUpdateStatusFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetCurrentUpdateStatus(val.(V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_currentUpdateStatusable))
        }
        return nil
    }
    ...
    res["unavailableSoftwareCatalogs"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogsable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogsable)
                }
            }
...
func (m *V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) GetLastPrecheckRunOn()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
...
func (m *V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) GetLastPrecheckRunVersion()(*string) {
...
// returns a *Time when successful
func (m *V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) GetLastUpdatedOn()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
...
// returns a []V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogsable when successful
func (m *V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) GetUnavailableSoftwareCatalogs()([]V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogsable) {
    return m.unavailableSoftwareCatalogs
}
// Serialize serializes information the current object
func (m *V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) SetAdditionalData(value map[string]any)() {
...
func (m *V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) SetAvailableSoftwareCatalogs(value []V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_availableSoftwareCatalogsable)() {
...
func (m *V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) SetCurrentSoftwareCatalog(value V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_currentSoftwareCatalogable)() {
...
func (m *V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) SetCurrentUpdateStatus(value V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_currentUpdateStatusable)() {
...
func (m *V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) SetLastPrecheckRunOn(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
...
func (m *V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) SetLastUpdatedOn(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
...
func (m *V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters) SetUnavailableSoftwareCatalogs(value []V1beta1SystemsItemGetResponse_softwareInfo_hypervisorClusters_unavailableSoftwareCatalogsable)() {
