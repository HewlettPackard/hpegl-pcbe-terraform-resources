...
type V1beta1SystemsItemPatchResponse_softwareInfo struct {
    ...
    currentUpdateStatus V1beta1SystemsItemPatchResponse_softwareInfo_currentUpdateStatusable
    // List of hypervisor clusters in the system with their software details.
    hypervisorClusters []V1beta1SystemsItemPatchResponse_softwareInfo_hypervisorClustersable
    ...
    pcForAiSoftwareInfo V1beta1SystemsItemPatchResponse_softwareInfo_pcForAiSoftwareInfoable
...
func NewV1beta1SystemsItemPatchResponse_softwareInfo()(*V1beta1SystemsItemPatchResponse_softwareInfo) {
    m := &V1beta1SystemsItemPatchResponse_softwareInfo{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsItemPatchResponse_softwareInfoFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1SystemsItemPatchResponse_softwareInfoFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsItemPatchResponse_softwareInfo(), nil
}
...
// returns a V1beta1SystemsItemPatchResponse_softwareInfo_currentUpdateStatusable when successful
func (m *V1beta1SystemsItemPatchResponse_softwareInfo) GetCurrentUpdateStatus()(V1beta1SystemsItemPatchResponse_softwareInfo_currentUpdateStatusable) {
    return m.currentUpdateStatus
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1SystemsItemPatchResponse_softwareInfo) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["currentUpdateStatus"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1SystemsItemPatchResponse_softwareInfo_currentUpdateStatusFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetCurrentUpdateStatus(val.(V1beta1SystemsItemPatchResponse_softwareInfo_currentUpdateStatusable))
        }
        return nil
    }
    res["hypervisorClusters"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1SystemsItemPatchResponse_softwareInfo_hypervisorClustersFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1SystemsItemPatchResponse_softwareInfo_hypervisorClustersable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(V1beta1SystemsItemPatchResponse_softwareInfo_hypervisorClustersable)
                }
            }
    ...
    res["pcForAiSoftwareInfo"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1SystemsItemPatchResponse_softwareInfo_pcForAiSoftwareInfoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetPcForAiSoftwareInfo(val.(V1beta1SystemsItemPatchResponse_softwareInfo_pcForAiSoftwareInfoable))
        }
        return nil
    }
...
// returns a []V1beta1SystemsItemPatchResponse_softwareInfo_hypervisorClustersable when successful
func (m *V1beta1SystemsItemPatchResponse_softwareInfo) GetHypervisorClusters()([]V1beta1SystemsItemPatchResponse_softwareInfo_hypervisorClustersable) {
...
func (m *V1beta1SystemsItemPatchResponse_softwareInfo) GetLastUpdatedOn()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
...
// returns a V1beta1SystemsItemPatchResponse_softwareInfo_pcForAiSoftwareInfoable when successful
func (m *V1beta1SystemsItemPatchResponse_softwareInfo) GetPcForAiSoftwareInfo()(V1beta1SystemsItemPatchResponse_softwareInfo_pcForAiSoftwareInfoable) {
...
// returns a *Time when successful
func (m *V1beta1SystemsItemPatchResponse_softwareInfo) GetPrecheckValidUntil()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.precheckValidUntil
}
// Serialize serializes information the current object
func (m *V1beta1SystemsItemPatchResponse_softwareInfo) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemsItemPatchResponse_softwareInfo) SetCurrentUpdateStatus(value V1beta1SystemsItemPatchResponse_softwareInfo_currentUpdateStatusable)() {
...
func (m *V1beta1SystemsItemPatchResponse_softwareInfo) SetHypervisorClusters(value []V1beta1SystemsItemPatchResponse_softwareInfo_hypervisorClustersable)() {
...
func (m *V1beta1SystemsItemPatchResponse_softwareInfo) SetLastUpdatedOn(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
...
func (m *V1beta1SystemsItemPatchResponse_softwareInfo) SetPcForAiSoftwareInfo(value V1beta1SystemsItemPatchResponse_softwareInfo_pcForAiSoftwareInfoable)() {
...
func (m *V1beta1SystemsItemPatchResponse_softwareInfo) SetPrecheckValidUntil(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.precheckValidUntil = value
}
type V1beta1SystemsItemPatchResponse_softwareInfoable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetCurrentUpdateStatus()(V1beta1SystemsItemPatchResponse_softwareInfo_currentUpdateStatusable)
    GetHypervisorClusters()([]V1beta1SystemsItemPatchResponse_softwareInfo_hypervisorClustersable)
    GetLastUpdatedOn()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)
    GetPcForAiSoftwareInfo()(V1beta1SystemsItemPatchResponse_softwareInfo_pcForAiSoftwareInfoable)
    GetPrecheckValidUntil()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)
    SetCurrentUpdateStatus(value V1beta1SystemsItemPatchResponse_softwareInfo_currentUpdateStatusable)()
    SetHypervisorClusters(value []V1beta1SystemsItemPatchResponse_softwareInfo_hypervisorClustersable)()
    SetLastUpdatedOn(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)()
    SetPcForAiSoftwareInfo(value V1beta1SystemsItemPatchResponse_softwareInfo_pcForAiSoftwareInfoable)()
