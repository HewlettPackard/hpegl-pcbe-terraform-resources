...
func NewV1beta1SystemSoftwareCatalogsGetResponse_items_systemsWithUpdatePath_hypervisorClusters()(*V1beta1SystemSoftwareCatalogsGetResponse_items_systemsWithUpdatePath_hypervisorClusters) {
    m := &V1beta1SystemSoftwareCatalogsGetResponse_items_systemsWithUpdatePath_hypervisorClusters{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemSoftwareCatalogsGetResponse_items_systemsWithUpdatePath_hypervisorClustersFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateV1beta1SystemSoftwareCatalogsGetResponse_items_systemsWithUpdatePath_hypervisorClustersFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemSoftwareCatalogsGetResponse_items_systemsWithUpdatePath_hypervisorClusters(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1SystemSoftwareCatalogsGetResponse_items_systemsWithUpdatePath_hypervisorClusters) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1SystemSoftwareCatalogsGetResponse_items_systemsWithUpdatePath_hypervisorClusters) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *V1beta1SystemSoftwareCatalogsGetResponse_items_systemsWithUpdatePath_hypervisorClusters) GetHypervisorClusterId()(*string) {
...
// returns a *string when successful
func (m *V1beta1SystemSoftwareCatalogsGetResponse_items_systemsWithUpdatePath_hypervisorClusters) GetHypervisorClusterName()(*string) {
    return m.hypervisorClusterName
}
// Serialize serializes information the current object
func (m *V1beta1SystemSoftwareCatalogsGetResponse_items_systemsWithUpdatePath_hypervisorClusters) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemSoftwareCatalogsGetResponse_items_systemsWithUpdatePath_hypervisorClusters) SetAdditionalData(value map[string]any)() {
...
func (m *V1beta1SystemSoftwareCatalogsGetResponse_items_systemsWithUpdatePath_hypervisorClusters) SetHypervisorClusterId(value *string)() {
...
func (m *V1beta1SystemSoftwareCatalogsGetResponse_items_systemsWithUpdatePath_hypervisorClusters) SetHypervisorClusterName(value *string)() {
