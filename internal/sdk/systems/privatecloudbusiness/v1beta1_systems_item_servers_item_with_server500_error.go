...
func NewV1beta1SystemsItemServersItemWithServer500Error()(*V1beta1SystemsItemServersItemWithServer500Error) {
    m := &V1beta1SystemsItemServersItemWithServer500Error{
        ApiError: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewApiError(),
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsItemServersItemWithServer500ErrorFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1SystemsItemServersItemWithServer500ErrorFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsItemServersItemWithServer500Error(), nil
}
// Error the primary error message.
// returns a string when successful
func (m *V1beta1SystemsItemServersItemWithServer500Error) Error()(string) {
...
// returns a *string when successful
func (m *V1beta1SystemsItemServersItemWithServer500Error) GetDebugId()(*string) {
    return m.debugId
}
// GetErrorCode gets the errorCode property value. A machine friendly identifier for the error response
// returns a *string when successful
func (m *V1beta1SystemsItemServersItemWithServer500Error) GetErrorCode()(*string) {
    return m.errorCode
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1SystemsItemServersItemWithServer500Error) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *V1beta1SystemsItemServersItemWithServer500Error) GetHttpStatusCode()(*int32) {
    return m.httpStatusCode
}
// GetMessage gets the message property value. A user-friendly error message
// returns a *string when successful
func (m *V1beta1SystemsItemServersItemWithServer500Error) GetMessage()(*string) {
    return m.message
}
// Serialize serializes information the current object
func (m *V1beta1SystemsItemServersItemWithServer500Error) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemsItemServersItemWithServer500Error) SetDebugId(value *string)() {
    m.debugId = value
}
// SetErrorCode sets the errorCode property value. A machine friendly identifier for the error response
func (m *V1beta1SystemsItemServersItemWithServer500Error) SetErrorCode(value *string)() {
    m.errorCode = value
}
...
func (m *V1beta1SystemsItemServersItemWithServer500Error) SetMessage(value *string)() {
    m.message = value
}
