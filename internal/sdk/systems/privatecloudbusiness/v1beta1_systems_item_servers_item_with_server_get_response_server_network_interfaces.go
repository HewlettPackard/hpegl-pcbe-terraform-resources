...
func NewV1beta1SystemsItemServersItemWithServerGetResponse_serverNetworkInterfaces()(*V1beta1SystemsItemServersItemWithServerGetResponse_serverNetworkInterfaces) {
    m := &V1beta1SystemsItemServersItemWithServerGetResponse_serverNetworkInterfaces{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsItemServersItemWithServerGetResponse_serverNetworkInterfacesFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateV1beta1SystemsItemServersItemWithServerGetResponse_serverNetworkInterfacesFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsItemServersItemWithServerGetResponse_serverNetworkInterfaces(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_serverNetworkInterfaces) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_serverNetworkInterfaces) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_serverNetworkInterfaces) GetMacAddress()(*string) {
    return m.macAddress
}
// GetSpeedGbps gets the speedGbps property value. speed
// returns a *float64 when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_serverNetworkInterfaces) GetSpeedGbps()(*float64) {
    return m.speedGbps
}
// Serialize serializes information the current object
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_serverNetworkInterfaces) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_serverNetworkInterfaces) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetMacAddress sets the macAddress property value. MAC address
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_serverNetworkInterfaces) SetMacAddress(value *string)() {
    m.macAddress = value
}
// SetSpeedGbps sets the speedGbps property value. speed
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_serverNetworkInterfaces) SetSpeedGbps(value *float64)() {
    m.speedGbps = value
}
