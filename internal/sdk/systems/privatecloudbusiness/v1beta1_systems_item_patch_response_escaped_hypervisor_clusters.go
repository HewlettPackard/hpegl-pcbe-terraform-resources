...
// V1beta1SystemsItemPatchResponse_hypervisorClusters hypervisor Cluster information.
type V1beta1SystemsItemPatchResponse_hypervisorClusters struct {
    ...
    // Secret information
    hypervisorManagerAdminPasswordSecret V1beta1SystemsItemPatchResponse_hypervisorClusters_hypervisorManagerAdminPasswordSecretable
...
func NewV1beta1SystemsItemPatchResponse_hypervisorClusters()(*V1beta1SystemsItemPatchResponse_hypervisorClusters) {
    m := &V1beta1SystemsItemPatchResponse_hypervisorClusters{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsItemPatchResponse_hypervisorClustersFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateV1beta1SystemsItemPatchResponse_hypervisorClustersFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsItemPatchResponse_hypervisorClusters(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1SystemsItemPatchResponse_hypervisorClusters) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1SystemsItemPatchResponse_hypervisorClusters) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["hypervisorManagerAdminPasswordSecret"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1SystemsItemPatchResponse_hypervisorClusters_hypervisorManagerAdminPasswordSecretFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetHypervisorManagerAdminPasswordSecret(val.(V1beta1SystemsItemPatchResponse_hypervisorClusters_hypervisorManagerAdminPasswordSecretable))
        }
        return nil
    }
...
// returns a V1beta1SystemsItemPatchResponse_hypervisorClusters_hypervisorManagerAdminPasswordSecretable when successful
func (m *V1beta1SystemsItemPatchResponse_hypervisorClusters) GetHypervisorManagerAdminPasswordSecret()(V1beta1SystemsItemPatchResponse_hypervisorClusters_hypervisorManagerAdminPasswordSecretable) {
...
// returns a *string when successful
func (m *V1beta1SystemsItemPatchResponse_hypervisorClusters) GetId()(*string) {
    return m.id
}
// GetName gets the name property value. Name of the Hypervisor Cluster
// returns a *string when successful
func (m *V1beta1SystemsItemPatchResponse_hypervisorClusters) GetName()(*string) {
    return m.name
}
// GetResourceUri gets the resourceUri property value. Resource URI of the Hypervisor Cluster.
// returns a *string when successful
func (m *V1beta1SystemsItemPatchResponse_hypervisorClusters) GetResourceUri()(*string) {
    return m.resourceUri
}
// Serialize serializes information the current object
func (m *V1beta1SystemsItemPatchResponse_hypervisorClusters) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemsItemPatchResponse_hypervisorClusters) SetHypervisorManagerAdminPasswordSecret(value V1beta1SystemsItemPatchResponse_hypervisorClusters_hypervisorManagerAdminPasswordSecretable)() {
...
func (m *V1beta1SystemsItemPatchResponse_hypervisorClusters) SetId(value *string)() {
    m.id = value
}
// SetName sets the name property value. Name of the Hypervisor Cluster
func (m *V1beta1SystemsItemPatchResponse_hypervisorClusters) SetName(value *string)() {
    m.name = value
}
// SetResourceUri sets the resourceUri property value. Resource URI of the Hypervisor Cluster.
func (m *V1beta1SystemsItemPatchResponse_hypervisorClusters) SetResourceUri(value *string)() {
    m.resourceUri = value
}
