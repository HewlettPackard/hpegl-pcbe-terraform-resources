...
func NewV1beta1SystemsGetResponse_items_storageSystem()(*V1beta1SystemsGetResponse_items_storageSystem) {
    m := &V1beta1SystemsGetResponse_items_storageSystem{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsGetResponse_items_storageSystemFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1SystemsGetResponse_items_storageSystemFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsGetResponse_items_storageSystem(), nil
}
...
// returns a *float64 when successful
func (m *V1beta1SystemsGetResponse_items_storageSystem) GetDedupeRatio()(*float64) {
    return m.dedupeRatio
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1SystemsGetResponse_items_storageSystem) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *string when successful
func (m *V1beta1SystemsGetResponse_items_storageSystem) GetGroupName()(*string) {
    return m.groupName
}
...
// returns a *string when successful
func (m *V1beta1SystemsGetResponse_items_storageSystem) GetGroupState()(*string) {
    return m.groupState
}
// GetId gets the id property value. Storage system identifier, usually a UUID.
// returns a *string when successful
func (m *V1beta1SystemsGetResponse_items_storageSystem) GetId()(*string) {
    return m.id
}
// GetName gets the name property value. Name of the storage system
// returns a *string when successful
func (m *V1beta1SystemsGetResponse_items_storageSystem) GetName()(*string) {
    return m.name
}
...
// returns a *float64 when successful
func (m *V1beta1SystemsGetResponse_items_storageSystem) GetNumberOfCores()(*float64) {
...
// returns a *float64 when successful
func (m *V1beta1SystemsGetResponse_items_storageSystem) GetNumberOfJbofs()(*float64) {
...
// returns a *float64 when successful
func (m *V1beta1SystemsGetResponse_items_storageSystem) GetNumberOfNodes()(*float64) {
    return m.numberOfNodes
}
// GetResourceUri gets the resourceUri property value. Resource URI of the storage system
// returns a *string when successful
func (m *V1beta1SystemsGetResponse_items_storageSystem) GetResourceUri()(*string) {
    return m.resourceUri
}
// GetStorageSerial gets the storageSerial property value. Serial number of the storage system.
// returns a *string when successful
func (m *V1beta1SystemsGetResponse_items_storageSystem) GetStorageSerial()(*string) {
    return m.storageSerial
}
// GetStorageType gets the storageType property value. Storage system type
// returns a *string when successful
func (m *V1beta1SystemsGetResponse_items_storageSystem) GetStorageType()(*string) {
    return m.storageType
}
// Serialize serializes information the current object
func (m *V1beta1SystemsGetResponse_items_storageSystem) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemsGetResponse_items_storageSystem) SetId(value *string)() {
    m.id = value
}
// SetName sets the name property value. Name of the storage system
func (m *V1beta1SystemsGetResponse_items_storageSystem) SetName(value *string)() {
    m.name = value
}
