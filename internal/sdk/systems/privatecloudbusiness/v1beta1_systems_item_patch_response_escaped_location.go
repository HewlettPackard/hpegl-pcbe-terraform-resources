...
func NewV1beta1SystemsItemPatchResponse_location()(*V1beta1SystemsItemPatchResponse_location) {
    m := &V1beta1SystemsItemPatchResponse_location{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsItemPatchResponse_locationFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1SystemsItemPatchResponse_locationFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsItemPatchResponse_location(), nil
}
...
func (m *V1beta1SystemsItemPatchResponse_location) GetCity()(*string) {
    return m.city
}
...
func (m *V1beta1SystemsItemPatchResponse_location) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
// returns a *string when successful
func (m *V1beta1SystemsItemPatchResponse_location) GetLatitude()(*string) {
    return m.latitude
}
// GetLongitude gets the longitude property value. Longitude coordinate of the system location
// returns a *string when successful
func (m *V1beta1SystemsItemPatchResponse_location) GetLongitude()(*string) {
    return m.longitude
}
// GetStateCode gets the stateCode property value. State Code
// returns a *string when successful
func (m *V1beta1SystemsItemPatchResponse_location) GetStateCode()(*string) {
    return m.stateCode
}
// GetZipCode gets the zipCode property value. Zip Code
// returns a *string when successful
func (m *V1beta1SystemsItemPatchResponse_location) GetZipCode()(*string) {
    return m.zipCode
}
// Serialize serializes information the current object
func (m *V1beta1SystemsItemPatchResponse_location) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemsItemPatchResponse_location) SetCity(value *string)() {
    m.city = value
}
