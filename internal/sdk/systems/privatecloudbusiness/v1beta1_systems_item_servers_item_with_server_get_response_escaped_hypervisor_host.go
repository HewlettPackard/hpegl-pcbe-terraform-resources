...
// V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost id, URI to reference the hypervisor host. Soon to be deprecated.
...
func NewV1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost()(*V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) {
    m := &V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHostFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
...
func CreateV1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHostFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) GetHypervisorClusterId()(*string) {
...
// returns a *string when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) GetHypervisorClusterName()(*string) {
    return m.hypervisorClusterName
}
// GetHypervisorHostIp gets the hypervisorHostIp property value. The hypervisorHostIp property
// returns a *string when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) GetHypervisorHostIp()(*string) {
    return m.hypervisorHostIp
}
// GetId gets the id property value. The id property
// returns a *string when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) GetId()(*string) {
    return m.id
}
// GetMaintenanceMode gets the maintenanceMode property value. Is the hypervisor host in maintenance mode?
// returns a *bool when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) GetMaintenanceMode()(*bool) {
    return m.maintenanceMode
}
// GetName gets the name property value. The name property
// returns a *string when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) GetName()(*string) {
    return m.name
}
// GetResourceUri gets the resourceUri property value. The resourceUri property
// returns a *string when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) GetResourceUri()(*string) {
    return m.resourceUri
}
// GetTypeEscaped gets the type property value. The type property
// returns a *string when successful
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) GetTypeEscaped()(*string) {
    return m.typeEscaped
}
// Serialize serializes information the current object
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetHypervisorClusterId sets the hypervisorClusterId property value. The hypervisorClusterId property
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) SetHypervisorClusterId(value *string)() {
...
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) SetHypervisorClusterName(value *string)() {
    m.hypervisorClusterName = value
}
// SetHypervisorHostIp sets the hypervisorHostIp property value. The hypervisorHostIp property
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) SetHypervisorHostIp(value *string)() {
    m.hypervisorHostIp = value
}
// SetId sets the id property value. The id property
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) SetId(value *string)() {
    m.id = value
}
// SetMaintenanceMode sets the maintenanceMode property value. Is the hypervisor host in maintenance mode?
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) SetMaintenanceMode(value *bool)() {
    m.maintenanceMode = value
}
// SetName sets the name property value. The name property
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) SetName(value *string)() {
    m.name = value
}
// SetResourceUri sets the resourceUri property value. The resourceUri property
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) SetResourceUri(value *string)() {
    m.resourceUri = value
}
// SetTypeEscaped sets the type property value. The type property
func (m *V1beta1SystemsItemServersItemWithServerGetResponse_hypervisorHost) SetTypeEscaped(value *string)() {
    m.typeEscaped = value
}
