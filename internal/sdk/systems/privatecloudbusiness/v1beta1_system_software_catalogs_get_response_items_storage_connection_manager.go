...
// V1beta1SystemSoftwareCatalogsGetResponse_items_storageConnectionManager details of the HPE Storage Connection Manager software. Applicable only for Alletra dHCI systems.
