...
// V1beta1SystemsItemPatchResponse_computeClusters compute cluster information.
type V1beta1SystemsItemPatchResponse_computeClusters struct {
    ...
    // Secret information
    hypervisorManagerAdminPasswordSecret V1beta1SystemsItemPatchResponse_computeClusters_hypervisorManagerAdminPasswordSecretable
...
// NewV1beta1SystemsItemPatchResponse_computeClusters instantiates a new V1beta1SystemsItemPatchResponse_computeClusters and sets the default values.
func NewV1beta1SystemsItemPatchResponse_computeClusters()(*V1beta1SystemsItemPatchResponse_computeClusters) {
    m := &V1beta1SystemsItemPatchResponse_computeClusters{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsItemPatchResponse_computeClustersFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1SystemsItemPatchResponse_computeClustersFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsItemPatchResponse_computeClusters(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1SystemsItemPatchResponse_computeClusters) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1SystemsItemPatchResponse_computeClusters) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["hypervisorManagerAdminPasswordSecret"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1SystemsItemPatchResponse_computeClusters_hypervisorManagerAdminPasswordSecretFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetHypervisorManagerAdminPasswordSecret(val.(V1beta1SystemsItemPatchResponse_computeClusters_hypervisorManagerAdminPasswordSecretable))
        }
        return nil
    }
...
func (m *V1beta1SystemsItemPatchResponse_computeClusters) GetHypervisorManagerAddress()(*string) {
...
// returns a V1beta1SystemsItemPatchResponse_computeClusters_hypervisorManagerAdminPasswordSecretable when successful
func (m *V1beta1SystemsItemPatchResponse_computeClusters) GetHypervisorManagerAdminPasswordSecret()(V1beta1SystemsItemPatchResponse_computeClusters_hypervisorManagerAdminPasswordSecretable) {
...
// returns a *string when successful
func (m *V1beta1SystemsItemPatchResponse_computeClusters) GetHypervisorManagerId()(*string) {
...
// returns a *string when successful
func (m *V1beta1SystemsItemPatchResponse_computeClusters) GetHypervisorManagerName()(*string) {
    return m.hypervisorManagerName
}
// GetId gets the id property value. Unique identifier of the compute cluster, usually a UUID.
// returns a *string when successful
func (m *V1beta1SystemsItemPatchResponse_computeClusters) GetId()(*string) {
    return m.id
}
// GetName gets the name property value. Name of the compute cluster.
// returns a *string when successful
func (m *V1beta1SystemsItemPatchResponse_computeClusters) GetName()(*string) {
    return m.name
}
// GetResourceUri gets the resourceUri property value. Resource URI of the compute cluster.
// returns a *string when successful
func (m *V1beta1SystemsItemPatchResponse_computeClusters) GetResourceUri()(*string) {
...
// returns a *string when successful
func (m *V1beta1SystemsItemPatchResponse_computeClusters) GetUserUrl()(*string) {
    return m.userUrl
}
// Serialize serializes information the current object
func (m *V1beta1SystemsItemPatchResponse_computeClusters) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SystemsItemPatchResponse_computeClusters) SetAdditionalData(value map[string]any)() {
...
func (m *V1beta1SystemsItemPatchResponse_computeClusters) SetHypervisorManagerAddress(value *string)() {
...
func (m *V1beta1SystemsItemPatchResponse_computeClusters) SetHypervisorManagerAdminPasswordSecret(value V1beta1SystemsItemPatchResponse_computeClusters_hypervisorManagerAdminPasswordSecretable)() {
...
func (m *V1beta1SystemsItemPatchResponse_computeClusters) SetHypervisorManagerId(value *string)() {
...
func (m *V1beta1SystemsItemPatchResponse_computeClusters) SetHypervisorManagerName(value *string)() {
    m.hypervisorManagerName = value
}
// SetId sets the id property value. Unique identifier of the compute cluster, usually a UUID.
func (m *V1beta1SystemsItemPatchResponse_computeClusters) SetId(value *string)() {
    m.id = value
}
// SetName sets the name property value. Name of the compute cluster.
func (m *V1beta1SystemsItemPatchResponse_computeClusters) SetName(value *string)() {
    m.name = value
}
// SetResourceUri sets the resourceUri property value. Resource URI of the compute cluster.
func (m *V1beta1SystemsItemPatchResponse_computeClusters) SetResourceUri(value *string)() {
    m.resourceUri = value
}
...
func (m *V1beta1SystemsItemPatchResponse_computeClusters) SetUserUrl(value *string)() {
    m.userUrl = value
}
type V1beta1SystemsItemPatchResponse_computeClustersable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetHypervisorManagerAddress()(*string)
    GetHypervisorManagerAdminPasswordSecret()(V1beta1SystemsItemPatchResponse_computeClusters_hypervisorManagerAdminPasswordSecretable)
    ...
    SetHypervisorManagerAdminPasswordSecret(value V1beta1SystemsItemPatchResponse_computeClusters_hypervisorManagerAdminPasswordSecretable)()
