...
func NewV1beta1SystemsGetResponse_items_storageUsage()(*V1beta1SystemsGetResponse_items_storageUsage) {
    m := &V1beta1SystemsGetResponse_items_storageUsage{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SystemsGetResponse_items_storageUsageFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1SystemsGetResponse_items_storageUsageFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SystemsGetResponse_items_storageUsage(), nil
}
...
func (m *V1beta1SystemsGetResponse_items_storageUsage) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *V1beta1SystemsGetResponse_items_storageUsage) GetSizeInBytes()(*float64) {
    return m.sizeInBytes
}
// GetUsageInBytes gets the usageInBytes property value. Storage Usage of the system
// returns a *float64 when successful
func (m *V1beta1SystemsGetResponse_items_storageUsage) GetUsageInBytes()(*float64) {
    return m.usageInBytes
}
// Serialize serializes information the current object
func (m *V1beta1SystemsGetResponse_items_storageUsage) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
