...
// V1beta1DataServicesConnectorsGetResponse_items detailed information of Data Services Collector
type V1beta1DataServicesConnectorsGetResponse_items struct {
    ...
    dateTime V1beta1DataServicesConnectorsGetResponse_items_dateTimeable
    ...
    hypervisorManagers []V1beta1DataServicesConnectorsGetResponse_items_hypervisorManagersable
    ...
    interfaces V1beta1DataServicesConnectorsGetResponse_items_interfacesable
    ...
    name *string
    // The ntp property
    ntp V1beta1DataServicesConnectorsGetResponse_items_ntpable
    ...
    rdaInfo V1beta1DataServicesConnectorsGetResponse_items_rdaInfoable
    ...
    serviceVersions []V1beta1DataServicesConnectorsGetResponse_items_serviceVersionsable
...
// NewV1beta1DataServicesConnectorsGetResponse_items instantiates a new V1beta1DataServicesConnectorsGetResponse_items and sets the default values.
func NewV1beta1DataServicesConnectorsGetResponse_items()(*V1beta1DataServicesConnectorsGetResponse_items) {
    m := &V1beta1DataServicesConnectorsGetResponse_items{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1DataServicesConnectorsGetResponse_itemsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1DataServicesConnectorsGetResponse_itemsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1DataServicesConnectorsGetResponse_items(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetCreatedAt gets the createdAt property value. The createdAt property
// returns a *Time when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetCreatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.createdAt
}
// GetCustomerId gets the customerId property value. The customer application identifier
// returns a *string when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetCustomerId()(*string) {
    return m.customerId
}
...
// returns a V1beta1DataServicesConnectorsGetResponse_items_dateTimeable when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetDateTime()(V1beta1DataServicesConnectorsGetResponse_items_dateTimeable) {
    return m.dateTime
}
// GetDeviceModel gets the deviceModel property value. Device model of Data Services Connector.
// returns a *string when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetDeviceModel()(*string) {
    return m.deviceModel
}
// GetDisplayName gets the displayName property value. User-defined name given to Data Services Connector.
// returns a *string when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetDisplayName()(*string) {
    return m.displayName
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["dateTime"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1DataServicesConnectorsGetResponse_items_dateTimeFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetDateTime(val.(V1beta1DataServicesConnectorsGetResponse_items_dateTimeable))
        }
        return nil
    }
    ...
    res["hypervisorManagers"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1DataServicesConnectorsGetResponse_items_hypervisorManagersFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1DataServicesConnectorsGetResponse_items_hypervisorManagersable, len(val))
            for i, v := range val {
                if v != nil {
    ...
    res["interfaces"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1DataServicesConnectorsGetResponse_items_interfacesFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetInterfaces(val.(V1beta1DataServicesConnectorsGetResponse_items_interfacesable))
        }
        return nil
    }
    ...
    res["ntp"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1DataServicesConnectorsGetResponse_items_ntpFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetNtp(val.(V1beta1DataServicesConnectorsGetResponse_items_ntpable))
        }
        return nil
    }
    ...
    res["rdaInfo"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1DataServicesConnectorsGetResponse_items_rdaInfoFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetRdaInfo(val.(V1beta1DataServicesConnectorsGetResponse_items_rdaInfoable))
        }
        return nil
    }
    ...
    res["serviceVersions"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1DataServicesConnectorsGetResponse_items_serviceVersionsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1DataServicesConnectorsGetResponse_items_serviceVersionsable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(V1beta1DataServicesConnectorsGetResponse_items_serviceVersionsable)
                }
            }
...
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetGeneration()(*int64) {
    return m.generation
}
...
// returns a []V1beta1DataServicesConnectorsGetResponse_items_hypervisorManagersable when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetHypervisorManagers()([]V1beta1DataServicesConnectorsGetResponse_items_hypervisorManagersable) {
    return m.hypervisorManagers
}
// GetId gets the id property value. Unique ID identifying a Data Services Connector.
// returns a *UUID when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetId()(*i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID) {
    return m.id
}
// GetInfosightEnabled gets the infosightEnabled property value. Indicates whether Infosight is enabled or disabled.
// returns a *bool when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetInfosightEnabled()(*bool) {
    return m.infosightEnabled
}
// GetInterfaces gets the interfaces property value. The interfaces property
// returns a V1beta1DataServicesConnectorsGetResponse_items_interfacesable when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetInterfaces()(V1beta1DataServicesConnectorsGetResponse_items_interfacesable) {
    return m.interfaces
}
...
// returns a *Time when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetLastUpdateCheckTime()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.lastUpdateCheckTime
}
// GetName gets the name property value. Name of Data Services Connector.
// returns a *string when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetName()(*string) {
    return m.name
}
// GetNtp gets the ntp property value. The ntp property
// returns a V1beta1DataServicesConnectorsGetResponse_items_ntpable when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetNtp()(V1beta1DataServicesConnectorsGetResponse_items_ntpable) {
    return m.ntp
}
// GetPersona gets the persona property value. Data Services Connector persona.
// returns a *string when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetPersona()(*string) {
    return m.persona
}
// GetPoweredOnAt gets the poweredOnAt property value. UTC time when Data Services Connector was last powered on.
// returns a *Time when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetPoweredOnAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.poweredOnAt
}
// GetProductName gets the productName property value. Product name of Data Services Connector.
// returns a *string when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetProductName()(*string) {
    return m.productName
}
// GetRdaInfo gets the rdaInfo property value. This provides details of the RDA for Data Services Connector.
// returns a V1beta1DataServicesConnectorsGetResponse_items_rdaInfoable when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetRdaInfo()(V1beta1DataServicesConnectorsGetResponse_items_rdaInfoable) {
    return m.rdaInfo
}
...
// returns a *UUID when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetRemoteAccessStationId()(*i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID) {
    return m.remoteAccessStationId
}
// GetResourceUri gets the resourceUri property value. The self reference for this resource.
// returns a *string when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetResourceUri()(*string) {
    return m.resourceUri
}
// GetSerialNumber gets the serialNumber property value. Data Services Connector serial number.
// returns a *string when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetSerialNumber()(*string) {
...
// returns a []V1beta1DataServicesConnectorsGetResponse_items_serviceVersionsable when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetServiceVersions()([]V1beta1DataServicesConnectorsGetResponse_items_serviceVersionsable) {
...
// returns a *string when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetSoftwareVersion()(*string) {
...
// returns a *string when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetStateReason()(*string) {
...
// returns a *string when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetStorageSystemSerialNumber()(*string) {
...
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetTotalMemoryInGiB()(*int32) {
    return m.totalMemoryInGiB
}
// GetTypeEscaped gets the type property value. The type of resource.
// returns a *string when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetTypeEscaped()(*string) {
    return m.typeEscaped
}
// GetUpdatedAt gets the updatedAt property value. The updatedAt property
// returns a *Time when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetUpdatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.updatedAt
}
...
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetUpTimeInSeconds()(*float64) {
...
// returns a *int32 when successful
func (m *V1beta1DataServicesConnectorsGetResponse_items) GetVCpu()(*int32) {
    return m.vCpu
}
// Serialize serializes information the current object
func (m *V1beta1DataServicesConnectorsGetResponse_items) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetCreatedAt sets the createdAt property value. The createdAt property
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetCreatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.createdAt = value
}
// SetCustomerId sets the customerId property value. The customer application identifier
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetCustomerId(value *string)() {
    m.customerId = value
}
...
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetDateTime(value V1beta1DataServicesConnectorsGetResponse_items_dateTimeable)() {
    m.dateTime = value
}
// SetDeviceModel sets the deviceModel property value. Device model of Data Services Connector.
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetDeviceModel(value *string)() {
    m.deviceModel = value
}
// SetDisplayName sets the displayName property value. User-defined name given to Data Services Connector.
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetDisplayName(value *string)() {
    m.displayName = value
}
...
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetGeneration(value *int64)() {
    m.generation = value
}
...
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetHypervisorManagers(value []V1beta1DataServicesConnectorsGetResponse_items_hypervisorManagersable)() {
    m.hypervisorManagers = value
}
// SetId sets the id property value. Unique ID identifying a Data Services Connector.
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetId(value *i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID)() {
    m.id = value
}
// SetInfosightEnabled sets the infosightEnabled property value. Indicates whether Infosight is enabled or disabled.
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetInfosightEnabled(value *bool)() {
    m.infosightEnabled = value
}
// SetInterfaces sets the interfaces property value. The interfaces property
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetInterfaces(value V1beta1DataServicesConnectorsGetResponse_items_interfacesable)() {
    m.interfaces = value
}
...
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetLastUpdateCheckTime(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.lastUpdateCheckTime = value
}
// SetName sets the name property value. Name of Data Services Connector.
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetName(value *string)() {
    m.name = value
}
// SetNtp sets the ntp property value. The ntp property
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetNtp(value V1beta1DataServicesConnectorsGetResponse_items_ntpable)() {
    m.ntp = value
}
// SetPersona sets the persona property value. Data Services Connector persona.
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetPersona(value *string)() {
    m.persona = value
}
// SetPoweredOnAt sets the poweredOnAt property value. UTC time when Data Services Connector was last powered on.
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetPoweredOnAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.poweredOnAt = value
}
// SetProductName sets the productName property value. Product name of Data Services Connector.
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetProductName(value *string)() {
    m.productName = value
}
// SetRdaInfo sets the rdaInfo property value. This provides details of the RDA for Data Services Connector.
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetRdaInfo(value V1beta1DataServicesConnectorsGetResponse_items_rdaInfoable)() {
    m.rdaInfo = value
}
...
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetRemoteAccessStationId(value *i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID)() {
    m.remoteAccessStationId = value
}
// SetResourceUri sets the resourceUri property value. The self reference for this resource.
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetResourceUri(value *string)() {
    m.resourceUri = value
}
// SetSerialNumber sets the serialNumber property value. Data Services Connector serial number.
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetSerialNumber(value *string)() {
...
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetServiceVersions(value []V1beta1DataServicesConnectorsGetResponse_items_serviceVersionsable)() {
...
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetSoftwareVersion(value *string)() {
...
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetStateReason(value *string)() {
    m.stateReason = value
}
...
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetStorageSystemSerialNumber(value *string)() {
...
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetTotalMemoryInGiB(value *int32)() {
    m.totalMemoryInGiB = value
}
// SetTypeEscaped sets the type property value. The type of resource.
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetTypeEscaped(value *string)() {
    m.typeEscaped = value
}
// SetUpdatedAt sets the updatedAt property value. The updatedAt property
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetUpdatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.updatedAt = value
}
...
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetUpTimeInSeconds(value *float64)() {
...
func (m *V1beta1DataServicesConnectorsGetResponse_items) SetVCpu(value *int32)() {
    m.vCpu = value
}
type V1beta1DataServicesConnectorsGetResponse_itemsable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetCreatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)
    GetCustomerId()(*string)
    GetDateTime()(V1beta1DataServicesConnectorsGetResponse_items_dateTimeable)
    ...
    GetInterfaces()(V1beta1DataServicesConnectorsGetResponse_items_interfacesable)
    GetLastUpdateCheckTime()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)
    GetName()(*string)
    GetNtp()(V1beta1DataServicesConnectorsGetResponse_items_ntpable)
    GetPersona()(*string)
    GetPoweredOnAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)
    GetProductName()(*string)
    GetRdaInfo()(V1beta1DataServicesConnectorsGetResponse_items_rdaInfoable)
    ...
    SetHypervisorManagers(value []V1beta1DataServicesConnectorsGetResponse_items_hypervisorManagersable)()
    SetId(value *i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID)()
    SetInfosightEnabled(value *bool)()
    SetInterfaces(value V1beta1DataServicesConnectorsGetResponse_items_interfacesable)()
    ...
    SetRdaInfo(value V1beta1DataServicesConnectorsGetResponse_items_rdaInfoable)()
    SetRemoteAccessStationId(value *i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID)()
    SetResourceUri(value *string)()
    SetSerialNumber(value *string)()
    SetServiceVersions(value []V1beta1DataServicesConnectorsGetResponse_items_serviceVersionsable)()
