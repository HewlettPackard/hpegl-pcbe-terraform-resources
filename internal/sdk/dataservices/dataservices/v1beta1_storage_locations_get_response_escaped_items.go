...
// V1beta1StorageLocationsGetResponse_items required properties of a storage location.
type V1beta1StorageLocationsGetResponse_items struct {
...
// NewV1beta1StorageLocationsGetResponse_items instantiates a new V1beta1StorageLocationsGetResponse_items and sets the default values.
func NewV1beta1StorageLocationsGetResponse_items()(*V1beta1StorageLocationsGetResponse_items) {
    m := &V1beta1StorageLocationsGetResponse_items{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1StorageLocationsGetResponse_itemsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1StorageLocationsGetResponse_itemsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1StorageLocationsGetResponse_items(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1StorageLocationsGetResponse_items) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetCapabilities gets the capabilities property value. The list of features that support the storage location.
// returns a []string when successful
func (m *V1beta1StorageLocationsGetResponse_items) GetCapabilities()([]string) {
    return m.capabilities
}
// GetCity gets the city property value. The city the storage location is in.
// returns a *string when successful
func (m *V1beta1StorageLocationsGetResponse_items) GetCity()(*string) {
    return m.city
}
// GetCloudServiceProviderId gets the cloudServiceProviderId property value. The Cloud Service Provider (CSP) ID.
// returns a *string when successful
func (m *V1beta1StorageLocationsGetResponse_items) GetCloudServiceProviderId()(*string) {
    return m.cloudServiceProviderId
}
// GetCreatedAt gets the createdAt property value. The createdAt property
// returns a *Time when successful
func (m *V1beta1StorageLocationsGetResponse_items) GetCreatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.createdAt
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1StorageLocationsGetResponse_items) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *V1beta1StorageLocationsGetResponse_items) GetGeneration()(*int64) {
    return m.generation
}
...
// returns a *string when successful
func (m *V1beta1StorageLocationsGetResponse_items) GetGeography()(*string) {
    return m.geography
}
// GetId gets the id property value. An identifier for the resource.
// returns a *string when successful
func (m *V1beta1StorageLocationsGetResponse_items) GetId()(*string) {
    return m.id
}
// GetName gets the name property value. A system specified name for the resource.
// returns a *string when successful
func (m *V1beta1StorageLocationsGetResponse_items) GetName()(*string) {
    return m.name
}
// GetResourceUri gets the resourceUri property value. The 'self' reference for this resource.
// returns a *string when successful
func (m *V1beta1StorageLocationsGetResponse_items) GetResourceUri()(*string) {
...
// returns a *string when successful
func (m *V1beta1StorageLocationsGetResponse_items) GetTimezone()(*string) {
    return m.timezone
}
// GetTypeEscaped gets the type property value. The type of resource.
// returns a *string when successful
func (m *V1beta1StorageLocationsGetResponse_items) GetTypeEscaped()(*string) {
    return m.typeEscaped
}
// GetUpdatedAt gets the updatedAt property value. The updatedAt property
// returns a *Time when successful
func (m *V1beta1StorageLocationsGetResponse_items) GetUpdatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.updatedAt
}
// Serialize serializes information the current object
func (m *V1beta1StorageLocationsGetResponse_items) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *V1beta1StorageLocationsGetResponse_items) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetCapabilities sets the capabilities property value. The list of features that support the storage location.
func (m *V1beta1StorageLocationsGetResponse_items) SetCapabilities(value []string)() {
    m.capabilities = value
}
// SetCity sets the city property value. The city the storage location is in.
func (m *V1beta1StorageLocationsGetResponse_items) SetCity(value *string)() {
    m.city = value
}
// SetCloudServiceProviderId sets the cloudServiceProviderId property value. The Cloud Service Provider (CSP) ID.
func (m *V1beta1StorageLocationsGetResponse_items) SetCloudServiceProviderId(value *string)() {
    m.cloudServiceProviderId = value
}
// SetCreatedAt sets the createdAt property value. The createdAt property
func (m *V1beta1StorageLocationsGetResponse_items) SetCreatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.createdAt = value
}
...
func (m *V1beta1StorageLocationsGetResponse_items) SetGeneration(value *int64)() {
    m.generation = value
}
...
func (m *V1beta1StorageLocationsGetResponse_items) SetGeography(value *string)() {
    m.geography = value
}
// SetId sets the id property value. An identifier for the resource.
func (m *V1beta1StorageLocationsGetResponse_items) SetId(value *string)() {
    m.id = value
}
// SetName sets the name property value. A system specified name for the resource.
func (m *V1beta1StorageLocationsGetResponse_items) SetName(value *string)() {
    m.name = value
}
// SetResourceUri sets the resourceUri property value. The 'self' reference for this resource.
func (m *V1beta1StorageLocationsGetResponse_items) SetResourceUri(value *string)() {
    m.resourceUri = value
}
...
func (m *V1beta1StorageLocationsGetResponse_items) SetTimezone(value *string)() {
    m.timezone = value
}
// SetTypeEscaped sets the type property value. The type of resource.
func (m *V1beta1StorageLocationsGetResponse_items) SetTypeEscaped(value *string)() {
    m.typeEscaped = value
}
// SetUpdatedAt sets the updatedAt property value. The updatedAt property
func (m *V1beta1StorageLocationsGetResponse_items) SetUpdatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.updatedAt = value
}
type V1beta1StorageLocationsGetResponse_itemsable interface {
