...
type V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse struct {
    // Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additionalData map[string]any
    // Resources associated with this operation
    associatedResources []V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_associatedResourcesable
    ...
    // Deprecated: 
    groups []V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_groupsable
    ...
    // Deprecated: 
    operationResource V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_operationResourceable
...
// NewV1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse instantiates a new V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse and sets the default values.
func NewV1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse()(*V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) {
    m := &V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1DualAuthOperationsItemDualAuthOperationsPatchResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1DualAuthOperationsItemDualAuthOperationsPatchResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetAssociatedResources gets the associatedResources property value. Resources associated with this operation
// returns a []V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_associatedResourcesable when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetAssociatedResources()([]V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_associatedResourcesable) {
...
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetCheckedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.checkedAt
}
...
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetCheckedByEmail()(*string) {
...
// returns a *string when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetCheckedByUri()(*string) {
...
// Deprecated: 
// returns a *string when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetConsoleUri()(*string) {
    return m.consoleUri
}
// GetCreatedAt gets the createdAt property value. The createdAt property
// returns a *Time when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetCreatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.createdAt
}
// GetCustomerId gets the customerId property value. The customer application identifier
// returns a *string when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetCustomerId()(*string) {
    return m.customerId
}
// GetDescription gets the description property value. Detailed description of the operation
// returns a *string when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetDescription()(*string) {
    return m.description
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["associatedResources"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_associatedResourcesFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_associatedResourcesable, len(val))
            for i, v := range val {
                if v != nil {
    ...
    res["groups"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_groupsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_groupsable, len(val))
            for i, v := range val {
                if v != nil {
    ...
    res["operationResource"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_operationResourceFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetOperationResource(val.(V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_operationResourceable))
        }
        return nil
    }
...
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetGeneration()(*int64) {
    return m.generation
}
...
// Deprecated: 
// returns a []V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_groupsable when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetGroups()([]V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_groupsable) {
    return m.groups
}
// GetId gets the id property value. An identifier for the resource, usually a UUID.
// returns a *UUID when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetId()(*i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID) {
    return m.id
}
// GetName gets the name property value. A system specified name for the resource.
// returns a *string when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetName()(*string) {
    return m.name
}
...
// Deprecated: 
// returns a V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_operationResourceable when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetOperationResource()(V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_operationResourceable) {
...
// returns a *Time when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetRequestedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
...
// returns a *string when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetRequestedByEmail()(*string) {
...
// returns a *string when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetRequestedByUri()(*string) {
...
// returns a *string when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetRequestedOperation()(*string) {
    return m.requestedOperation
}
// GetResourceUri gets the resourceUri property value. The self reference for this resource.
// returns a *string when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetResourceUri()(*string) {
...
// returns a *string when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetSourceServiceExternalName()(*string) {
    return m.sourceServiceExternalName
}
// GetState gets the state property value. state of this operation
// returns a *string when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetState()(*string) {
    return m.state
}
// GetTypeEscaped gets the type property value. The type of resource.
// returns a *string when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetTypeEscaped()(*string) {
    return m.typeEscaped
}
// GetUpdatedAt gets the updatedAt property value. The updatedAt property
// returns a *Time when successful
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) GetUpdatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.updatedAt
}
// Serialize serializes information the current object
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetAssociatedResources sets the associatedResources property value. Resources associated with this operation
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetAssociatedResources(value []V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_associatedResourcesable)() {
...
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetCheckedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.checkedAt = value
}
...
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetCheckedByEmail(value *string)() {
...
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetCheckedByUri(value *string)() {
...
// Deprecated: 
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetConsoleUri(value *string)() {
    m.consoleUri = value
}
// SetCreatedAt sets the createdAt property value. The createdAt property
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetCreatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.createdAt = value
}
// SetCustomerId sets the customerId property value. The customer application identifier
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetCustomerId(value *string)() {
    m.customerId = value
}
// SetDescription sets the description property value. Detailed description of the operation
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetDescription(value *string)() {
    m.description = value
}
...
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetGeneration(value *int64)() {
    m.generation = value
}
...
// Deprecated: 
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetGroups(value []V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_groupsable)() {
    m.groups = value
}
// SetId sets the id property value. An identifier for the resource, usually a UUID.
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetId(value *i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID)() {
    m.id = value
}
// SetName sets the name property value. A system specified name for the resource.
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetName(value *string)() {
    m.name = value
}
...
// Deprecated: 
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetOperationResource(value V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_operationResourceable)() {
...
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetRequestedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.requestedAt = value
}
// SetRequestedByEmail sets the requestedByEmail property value. Email of the user who performed this operation
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetRequestedByEmail(value *string)() {
...
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetRequestedByUri(value *string)() {
...
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetRequestedOperation(value *string)() {
    m.requestedOperation = value
}
// SetResourceUri sets the resourceUri property value. The self reference for this resource.
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetResourceUri(value *string)() {
    m.resourceUri = value
}
...
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetSourceServiceExternalName(value *string)() {
    m.sourceServiceExternalName = value
}
// SetState sets the state property value. state of this operation
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetState(value *string)() {
    m.state = value
}
// SetTypeEscaped sets the type property value. The type of resource.
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetTypeEscaped(value *string)() {
    m.typeEscaped = value
}
// SetUpdatedAt sets the updatedAt property value. The updatedAt property
func (m *V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse) SetUpdatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.updatedAt = value
}
type V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponseable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetAssociatedResources()([]V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_associatedResourcesable)
    ...
    GetGeneration()(*int64)
    GetGroups()([]V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_groupsable)
    GetId()(*i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID)
    GetName()(*string)
    GetOperationResource()(V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_operationResourceable)
    ...
    SetAssociatedResources(value []V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_associatedResourcesable)()
    ...
    SetGroups(value []V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_groupsable)()
    SetId(value *i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID)()
    SetName(value *string)()
    SetOperationResource(value V1beta1DualAuthOperationsItemDualAuthOperationsPatchResponse_operationResourceable)()
