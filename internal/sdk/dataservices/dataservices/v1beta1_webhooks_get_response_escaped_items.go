...
// V1beta1WebhooksGetResponse_items a Webhook resource
type V1beta1WebhooksGetResponse_items struct {
    // Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additionalData map[string]any
    // An object containing an identity that is used to authorize published events
    authorization V1beta1WebhooksGetResponse_items_authorizationable
    ...
    destinations []V1beta1WebhooksGetResponse_items_destinationsable
    // A monotonically increasing value. This value updates when the resource is updated and can be used as a short way to determine if a resource has changed or which of two different copies of a resource is more up to date.
    generation *int64
    // List of group associations
    groups []V1beta1WebhooksGetResponse_items_groupsable
    ...
    subscriptions []V1beta1WebhooksGetResponse_items_subscriptionsable
    // The type of resource.
    typeEscaped *string
    // The updatedAt property
    updatedAt *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time
}
// NewV1beta1WebhooksGetResponse_items instantiates a new V1beta1WebhooksGetResponse_items and sets the default values.
func NewV1beta1WebhooksGetResponse_items()(*V1beta1WebhooksGetResponse_items) {
    m := &V1beta1WebhooksGetResponse_items{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1WebhooksGetResponse_itemsFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1WebhooksGetResponse_itemsFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1WebhooksGetResponse_items(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1WebhooksGetResponse_items) GetAdditionalData()(map[string]any) {
...
// returns a V1beta1WebhooksGetResponse_items_authorizationable when successful
func (m *V1beta1WebhooksGetResponse_items) GetAuthorization()(V1beta1WebhooksGetResponse_items_authorizationable) {
    return m.authorization
}
// GetConsoleUri gets the consoleUri property value. URI that opens the webhook in the UI console
// returns a *string when successful
func (m *V1beta1WebhooksGetResponse_items) GetConsoleUri()(*string) {
    return m.consoleUri
}
// GetCreatedAt gets the createdAt property value. The createdAt property
// returns a *Time when successful
func (m *V1beta1WebhooksGetResponse_items) GetCreatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.createdAt
}
// GetCustomerId gets the customerId property value. The customer application identifier
// returns a *string when successful
func (m *V1beta1WebhooksGetResponse_items) GetCustomerId()(*string) {
    return m.customerId
}
// GetDestinations gets the destinations property value. List of event destinations
// returns a []V1beta1WebhooksGetResponse_items_destinationsable when successful
func (m *V1beta1WebhooksGetResponse_items) GetDestinations()([]V1beta1WebhooksGetResponse_items_destinationsable) {
    return m.destinations
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1WebhooksGetResponse_items) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["authorization"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateV1beta1WebhooksGetResponse_items_authorizationFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetAuthorization(val.(V1beta1WebhooksGetResponse_items_authorizationable))
        }
        return nil
    }
    ...
    res["destinations"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1WebhooksGetResponse_items_destinationsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1WebhooksGetResponse_items_destinationsable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(V1beta1WebhooksGetResponse_items_destinationsable)
                }
            }
    ...
    res["groups"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1WebhooksGetResponse_items_groupsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1WebhooksGetResponse_items_groupsable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(V1beta1WebhooksGetResponse_items_groupsable)
                }
            }
            m.SetGroups(res)
        }
    ...
    res["subscriptions"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1WebhooksGetResponse_items_subscriptionsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1WebhooksGetResponse_items_subscriptionsable, len(val))
            for i, v := range val {
                if v != nil {
...
func (m *V1beta1WebhooksGetResponse_items) GetGeneration()(*int64) {
    return m.generation
}
// GetGroups gets the groups property value. List of group associations
// returns a []V1beta1WebhooksGetResponse_items_groupsable when successful
func (m *V1beta1WebhooksGetResponse_items) GetGroups()([]V1beta1WebhooksGetResponse_items_groupsable) {
    return m.groups
}
// GetId gets the id property value. An identifier for the resource, usually a UUID.
// returns a *UUID when successful
func (m *V1beta1WebhooksGetResponse_items) GetId()(*i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID) {
    return m.id
}
...
// returns a *Time when successful
func (m *V1beta1WebhooksGetResponse_items) GetLastEventDeliveredAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.lastEventDeliveredAt
}
// GetName gets the name property value. A system specified name for the resource.
// returns a *string when successful
func (m *V1beta1WebhooksGetResponse_items) GetName()(*string) {
    return m.name
}
// GetResourceUri gets the resourceUri property value. The self reference for this resource.
// returns a *string when successful
func (m *V1beta1WebhooksGetResponse_items) GetResourceUri()(*string) {
...
// returns a []V1beta1WebhooksGetResponse_items_subscriptionsable when successful
func (m *V1beta1WebhooksGetResponse_items) GetSubscriptions()([]V1beta1WebhooksGetResponse_items_subscriptionsable) {
    return m.subscriptions
}
// GetTypeEscaped gets the type property value. The type of resource.
// returns a *string when successful
func (m *V1beta1WebhooksGetResponse_items) GetTypeEscaped()(*string) {
    return m.typeEscaped
}
// GetUpdatedAt gets the updatedAt property value. The updatedAt property
// returns a *Time when successful
func (m *V1beta1WebhooksGetResponse_items) GetUpdatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.updatedAt
}
// Serialize serializes information the current object
func (m *V1beta1WebhooksGetResponse_items) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1WebhooksGetResponse_items) SetAdditionalData(value map[string]any)() {
...
func (m *V1beta1WebhooksGetResponse_items) SetAuthorization(value V1beta1WebhooksGetResponse_items_authorizationable)() {
    m.authorization = value
}
// SetConsoleUri sets the consoleUri property value. URI that opens the webhook in the UI console
func (m *V1beta1WebhooksGetResponse_items) SetConsoleUri(value *string)() {
    m.consoleUri = value
}
// SetCreatedAt sets the createdAt property value. The createdAt property
func (m *V1beta1WebhooksGetResponse_items) SetCreatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.createdAt = value
}
// SetCustomerId sets the customerId property value. The customer application identifier
func (m *V1beta1WebhooksGetResponse_items) SetCustomerId(value *string)() {
    m.customerId = value
}
// SetDestinations sets the destinations property value. List of event destinations
func (m *V1beta1WebhooksGetResponse_items) SetDestinations(value []V1beta1WebhooksGetResponse_items_destinationsable)() {
...
func (m *V1beta1WebhooksGetResponse_items) SetGeneration(value *int64)() {
    m.generation = value
}
// SetGroups sets the groups property value. List of group associations
func (m *V1beta1WebhooksGetResponse_items) SetGroups(value []V1beta1WebhooksGetResponse_items_groupsable)() {
    m.groups = value
}
// SetId sets the id property value. An identifier for the resource, usually a UUID.
func (m *V1beta1WebhooksGetResponse_items) SetId(value *i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID)() {
    m.id = value
}
...
func (m *V1beta1WebhooksGetResponse_items) SetLastEventDeliveredAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.lastEventDeliveredAt = value
}
// SetName sets the name property value. A system specified name for the resource.
func (m *V1beta1WebhooksGetResponse_items) SetName(value *string)() {
    m.name = value
}
// SetResourceUri sets the resourceUri property value. The self reference for this resource.
func (m *V1beta1WebhooksGetResponse_items) SetResourceUri(value *string)() {
    m.resourceUri = value
}
...
func (m *V1beta1WebhooksGetResponse_items) SetSubscriptions(value []V1beta1WebhooksGetResponse_items_subscriptionsable)() {
    m.subscriptions = value
}
// SetTypeEscaped sets the type property value. The type of resource.
func (m *V1beta1WebhooksGetResponse_items) SetTypeEscaped(value *string)() {
    m.typeEscaped = value
}
// SetUpdatedAt sets the updatedAt property value. The updatedAt property
func (m *V1beta1WebhooksGetResponse_items) SetUpdatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.updatedAt = value
}
type V1beta1WebhooksGetResponse_itemsable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetAuthorization()(V1beta1WebhooksGetResponse_items_authorizationable)
    GetConsoleUri()(*string)
    GetCreatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)
    GetCustomerId()(*string)
    GetDestinations()([]V1beta1WebhooksGetResponse_items_destinationsable)
    GetGeneration()(*int64)
    GetGroups()([]V1beta1WebhooksGetResponse_items_groupsable)
    ...
    SetAuthorization(value V1beta1WebhooksGetResponse_items_authorizationable)()
    ...
    SetSubscriptions(value []V1beta1WebhooksGetResponse_items_subscriptionsable)()
