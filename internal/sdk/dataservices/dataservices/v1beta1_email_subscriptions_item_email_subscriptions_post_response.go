...
// V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse common properties included in all resource models.
type V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse struct {
    ...
    groups []V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse_groupsable
...
// NewV1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse instantiates a new V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse and sets the default values.
func NewV1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse()(*V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse) {
    m := &V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse(), nil
}
// GetActivated gets the activated property value. If true, user activated this email subscription. Otherwise, false.
// returns a *bool when successful
func (m *V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse) GetActivated()(*bool) {
    return m.activated
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse) GetAdditionalData()(map[string]any) {
...
func (m *V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse) GetCategories()([]string) {
    return m.categories
}
...
// returns a *string when successful
func (m *V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse) GetConsoleUri()(*string) {
    return m.consoleUri
}
...
// returns a *string when successful
func (m *V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse) GetDescription()(*string) {
    return m.description
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["groups"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse_groupsFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse_groupsable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse_groupsable)
                }
            }
            m.SetGroups(res)
        }
...
// returns a []V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse_groupsable when successful
func (m *V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse) GetGroups()([]V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse_groupsable) {
    return m.groups
}
...
// returns a *string when successful
func (m *V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse) GetServiceName()(*string) {
    return m.serviceName
}
// Serialize serializes information the current object
func (m *V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse) SetActivated(value *bool)() {
    m.activated = value
}
// SetAdditionalData sets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
func (m *V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse) SetAdditionalData(value map[string]any)() {
...
func (m *V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse) SetCategories(value []string)() {
    m.categories = value
}
...
func (m *V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse) SetConsoleUri(value *string)() {
    m.consoleUri = value
}
...
func (m *V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse) SetDescription(value *string)() {
    m.description = value
}
// SetGroups sets the groups property value. Groups the email subscription is associated with.
func (m *V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse) SetGroups(value []V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse_groupsable)() {
    m.groups = value
}
...
func (m *V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse) SetServiceName(value *string)() {
    m.serviceName = value
}
type V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponseable interface {
    ...
    GetGroups()([]V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse_groupsable)
    GetServiceName()(*string)
    SetActivated(value *bool)()
    SetCategories(value []string)()
    SetConsoleUri(value *string)()
    SetDescription(value *string)()
    SetGroups(value []V1beta1EmailSubscriptionsItemEmailSubscriptionsPostResponse_groupsable)()
