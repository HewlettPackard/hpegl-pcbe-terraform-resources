...
type V1beta1SettingsItemSettingsGetResponse struct {
...
// NewV1beta1SettingsItemSettingsGetResponse instantiates a new V1beta1SettingsItemSettingsGetResponse and sets the default values.
func NewV1beta1SettingsItemSettingsGetResponse()(*V1beta1SettingsItemSettingsGetResponse) {
    m := &V1beta1SettingsItemSettingsGetResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1SettingsItemSettingsGetResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1SettingsItemSettingsGetResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1SettingsItemSettingsGetResponse(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1SettingsItemSettingsGetResponse) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetConsoleUri gets the consoleUri property value. The URI for console screen that displays this resource
// returns a *string when successful
func (m *V1beta1SettingsItemSettingsGetResponse) GetConsoleUri()(*string) {
    return m.consoleUri
}
// GetCreatedAt gets the createdAt property value. The createdAt property
// returns a *Time when successful
func (m *V1beta1SettingsItemSettingsGetResponse) GetCreatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.createdAt
}
// GetCurrentValue gets the currentValue property value. Value of the setting
// returns a *string when successful
func (m *V1beta1SettingsItemSettingsGetResponse) GetCurrentValue()(*string) {
    return m.currentValue
}
// GetCustomerId gets the customerId property value. The customer application identifier
// returns a *string when successful
func (m *V1beta1SettingsItemSettingsGetResponse) GetCustomerId()(*string) {
    return m.customerId
}
// GetDescription gets the description property value. Description of the setting
// returns a *string when successful
func (m *V1beta1SettingsItemSettingsGetResponse) GetDescription()(*string) {
...
// returns a *string when successful
func (m *V1beta1SettingsItemSettingsGetResponse) GetExternalApplicationName()(*string) {
    return m.externalApplicationName
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1SettingsItemSettingsGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
...
func (m *V1beta1SettingsItemSettingsGetResponse) GetGeneration()(*int64) {
    return m.generation
}
// GetId gets the id property value. An identifier for the resource, usually a UUID.
// returns a *UUID when successful
func (m *V1beta1SettingsItemSettingsGetResponse) GetId()(*i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID) {
    return m.id
}
// GetLastUpdatedAt gets the lastUpdatedAt property value. Time when this setting was last updated for this account. RFC 3339
// returns a *string when successful
func (m *V1beta1SettingsItemSettingsGetResponse) GetLastUpdatedAt()(*string) {
...
// returns a *string when successful
func (m *V1beta1SettingsItemSettingsGetResponse) GetPossibleValues()(*string) {
    return m.possibleValues
}
// GetResourceUri gets the resourceUri property value. The self reference for this resource.
// returns a *string when successful
func (m *V1beta1SettingsItemSettingsGetResponse) GetResourceUri()(*string) {
    return m.resourceUri
}
// GetTypeEscaped gets the type property value. The type of resource.
// returns a *string when successful
func (m *V1beta1SettingsItemSettingsGetResponse) GetTypeEscaped()(*string) {
    return m.typeEscaped
}
// GetUpdatedAt gets the updatedAt property value. The updatedAt property
// returns a *Time when successful
func (m *V1beta1SettingsItemSettingsGetResponse) GetUpdatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.updatedAt
}
// Serialize serializes information the current object
func (m *V1beta1SettingsItemSettingsGetResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *V1beta1SettingsItemSettingsGetResponse) SetAdditionalData(value map[string]any)() {
    m.additionalData = value
}
// SetConsoleUri sets the consoleUri property value. The URI for console screen that displays this resource
func (m *V1beta1SettingsItemSettingsGetResponse) SetConsoleUri(value *string)() {
    m.consoleUri = value
}
// SetCreatedAt sets the createdAt property value. The createdAt property
func (m *V1beta1SettingsItemSettingsGetResponse) SetCreatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.createdAt = value
}
// SetCurrentValue sets the currentValue property value. Value of the setting
func (m *V1beta1SettingsItemSettingsGetResponse) SetCurrentValue(value *string)() {
    m.currentValue = value
}
// SetCustomerId sets the customerId property value. The customer application identifier
func (m *V1beta1SettingsItemSettingsGetResponse) SetCustomerId(value *string)() {
    m.customerId = value
}
// SetDescription sets the description property value. Description of the setting
func (m *V1beta1SettingsItemSettingsGetResponse) SetDescription(value *string)() {
    m.description = value
}
// SetExternalApplicationName sets the externalApplicationName property value. Name of the application to be displayed in UI
func (m *V1beta1SettingsItemSettingsGetResponse) SetExternalApplicationName(value *string)() {
...
func (m *V1beta1SettingsItemSettingsGetResponse) SetGeneration(value *int64)() {
    m.generation = value
}
// SetId sets the id property value. An identifier for the resource, usually a UUID.
func (m *V1beta1SettingsItemSettingsGetResponse) SetId(value *i561e97a8befe7661a44c8f54600992b4207a3a0cf6770e5559949bc276de2e22.UUID)() {
    m.id = value
}
// SetLastUpdatedAt sets the lastUpdatedAt property value. Time when this setting was last updated for this account. RFC 3339
func (m *V1beta1SettingsItemSettingsGetResponse) SetLastUpdatedAt(value *string)() {
...
func (m *V1beta1SettingsItemSettingsGetResponse) SetLastUpdatedBy(value *string)() {
    m.lastUpdatedBy = value
}
// SetName sets the name property value. A system specified name for the resource.
func (m *V1beta1SettingsItemSettingsGetResponse) SetName(value *string)() {
    m.name = value
}
// SetNextValue sets the nextValue property value. Next possible value of the setting, which is updated by the workflow
func (m *V1beta1SettingsItemSettingsGetResponse) SetNextValue(value *string)() {
    m.nextValue = value
}
...
func (m *V1beta1SettingsItemSettingsGetResponse) SetPossibleValues(value *string)() {
    m.possibleValues = value
}
// SetResourceUri sets the resourceUri property value. The self reference for this resource.
func (m *V1beta1SettingsItemSettingsGetResponse) SetResourceUri(value *string)() {
    m.resourceUri = value
}
// SetTypeEscaped sets the type property value. The type of resource.
func (m *V1beta1SettingsItemSettingsGetResponse) SetTypeEscaped(value *string)() {
    m.typeEscaped = value
}
// SetUpdatedAt sets the updatedAt property value. The updatedAt property
func (m *V1beta1SettingsItemSettingsGetResponse) SetUpdatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.updatedAt = value
}
type V1beta1SettingsItemSettingsGetResponseable interface {
