...
type V1beta1GroupsPostResponse struct {
    ...
    associatedResourceTypes []V1beta1GroupsPostResponse_associatedResourceTypesable
...
// NewV1beta1GroupsPostResponse instantiates a new V1beta1GroupsPostResponse and sets the default values.
func NewV1beta1GroupsPostResponse()(*V1beta1GroupsPostResponse) {
    m := &V1beta1GroupsPostResponse{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateV1beta1GroupsPostResponseFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateV1beta1GroupsPostResponseFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewV1beta1GroupsPostResponse(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *V1beta1GroupsPostResponse) GetAdditionalData()(map[string]any) {
...
// returns a []V1beta1GroupsPostResponse_associatedResourceTypesable when successful
func (m *V1beta1GroupsPostResponse) GetAssociatedResourceTypes()([]V1beta1GroupsPostResponse_associatedResourceTypesable) {
...
func (m *V1beta1GroupsPostResponse) GetAssociationCount()(*int32) {
...
func (m *V1beta1GroupsPostResponse) GetConsoleUri()(*string) {
    return m.consoleUri
}
...
func (m *V1beta1GroupsPostResponse) GetCreatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.createdAt
}
// GetCustomerId gets the customerId property value. Primary identifier for the customer (GUID) associated with the group.
// returns a *string when successful
func (m *V1beta1GroupsPostResponse) GetCustomerId()(*string) {
    return m.customerId
}
...
// returns a *string when successful
func (m *V1beta1GroupsPostResponse) GetDescription()(*string) {
    return m.description
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *V1beta1GroupsPostResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["associatedResourceTypes"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateV1beta1GroupsPostResponse_associatedResourceTypesFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]V1beta1GroupsPostResponse_associatedResourceTypesable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(V1beta1GroupsPostResponse_associatedResourceTypesable)
                }
            }
...
// returns a *int32 when successful
func (m *V1beta1GroupsPostResponse) GetGeneration()(*int32) {
    return m.generation
}
// GetGroupType gets the groupType property value. Type of group
// returns a *int32 when successful
func (m *V1beta1GroupsPostResponse) GetGroupType()(*int32) {
    return m.groupType
}
...
// returns a *string when successful
func (m *V1beta1GroupsPostResponse) GetId()(*string) {
    return m.id
}
...
// returns a *string when successful
func (m *V1beta1GroupsPostResponse) GetName()(*string) {
    return m.name
}
...
// returns a *string when successful
func (m *V1beta1GroupsPostResponse) GetResourceUri()(*string) {
    return m.resourceUri
}
// GetTypeEscaped gets the type property value. The type of the resource. Used for grouping of like resources.
// returns a *string when successful
func (m *V1beta1GroupsPostResponse) GetTypeEscaped()(*string) {
...
// returns a *Time when successful
func (m *V1beta1GroupsPostResponse) GetUpdatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.updatedAt
}
// GetUpdatedBy gets the updatedBy property value. The user that performed the most recent modifying operation on the Group.
// returns a *string when successful
func (m *V1beta1GroupsPostResponse) GetUpdatedBy()(*string) {
    return m.updatedBy
}
// Serialize serializes information the current object
func (m *V1beta1GroupsPostResponse) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
...
func (m *V1beta1GroupsPostResponse) SetAdditionalData(value map[string]any)() {
...
func (m *V1beta1GroupsPostResponse) SetAssociatedResourceTypes(value []V1beta1GroupsPostResponse_associatedResourceTypesable)() {
...
func (m *V1beta1GroupsPostResponse) SetAssociationCount(value *int32)() {
...
func (m *V1beta1GroupsPostResponse) SetConsoleUri(value *string)() {
    m.consoleUri = value
}
...
func (m *V1beta1GroupsPostResponse) SetCreatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.createdAt = value
}
// SetCustomerId sets the customerId property value. Primary identifier for the customer (GUID) associated with the group.
func (m *V1beta1GroupsPostResponse) SetCustomerId(value *string)() {
    m.customerId = value
}
...
func (m *V1beta1GroupsPostResponse) SetDescription(value *string)() {
    m.description = value
}
...
func (m *V1beta1GroupsPostResponse) SetGeneration(value *int32)() {
    m.generation = value
}
// SetGroupType sets the groupType property value. Type of group
func (m *V1beta1GroupsPostResponse) SetGroupType(value *int32)() {
    m.groupType = value
}
...
func (m *V1beta1GroupsPostResponse) SetId(value *string)() {
    m.id = value
}
...
func (m *V1beta1GroupsPostResponse) SetName(value *string)() {
    m.name = value
}
...
func (m *V1beta1GroupsPostResponse) SetResourceUri(value *string)() {
    m.resourceUri = value
}
// SetTypeEscaped sets the type property value. The type of the resource. Used for grouping of like resources.
func (m *V1beta1GroupsPostResponse) SetTypeEscaped(value *string)() {
    m.typeEscaped = value
}
...
func (m *V1beta1GroupsPostResponse) SetUpdatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)() {
    m.updatedAt = value
}
// SetUpdatedBy sets the updatedBy property value. The user that performed the most recent modifying operation on the Group.
func (m *V1beta1GroupsPostResponse) SetUpdatedBy(value *string)() {
    m.updatedBy = value
}
type V1beta1GroupsPostResponseable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetAssociatedResourceTypes()([]V1beta1GroupsPostResponse_associatedResourceTypesable)
    ...
    GetUpdatedBy()(*string)
    SetAssociatedResourceTypes(value []V1beta1GroupsPostResponse_associatedResourceTypesable)()
